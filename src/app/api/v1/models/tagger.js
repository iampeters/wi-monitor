...
const tagger2 = ( logged_in_user_id, randNum, subject_id, callback ) => {
  var sql = `UPDATE tag set opponent_id = '${logged_in_user_id}', session_key = '${randNum}', is_merged = '1' where subject_id = '${subject_id}' and has_ended = 'false' and is_merged = '0'`;
...
module.exports = {
  ...
  merged_select_users: merged_select_users,
