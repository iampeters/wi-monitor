...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        easeInBack: function(t, e, i, n, o, a) { return void 0 == a && (a = 1.70158), n * (e /= o) * e * ((a + 1) * e - a) + i },
        easeOutBack: function(t, e, i, n, o, a) { return void 0 == a && (a = 1.70158), n * ((e = e / o - 1) * e * ((a + 1) * e + a) + 1) + i },
        easeInOutBack: function(t, e, i, n, o, a) { return void 0 == a && (a = 1.70158), (e /= o / 2) < 1 ? n / 2 * (e * e * ((1 + (a *= 1.525)) * e - a)) + i : n / 2 * ((e -= 2) * e * ((1 + (a *= 1.525)) * e + a) + 2) + i },
        ...
        return function(t, e, i, n) {
            ...
            function r(t, i, n, o) {
                ...
                function h() { k = !0, (t != i || n != o) && function() { for (var e = 0; v > e; ++e) w[e] = l(e * y, t, n) }() }
                var f = 4,
                    p = .001,
                    m = 1e-7,
                    g = 10,
                            ...
                            for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                                ...
                                if (a(C)) {
                                    ...
                                    if (d.display !== n && null !== d.display && "none" !== d.display) {
                                        if ("flex" === d.display) { u.each(["-webkit-box", "-moz-box", "-ms-flexbox", "-webkit-flex"], function(t, e) { b.setPropertyValue(C, "display", e) }) }
                                    ...
                                    for (var T in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), k)
                                        if ("element" !== T) {
                                            ...
                                            if (1 === g) M = I.endValue;
                                            else { var A = I.endValue - I.startValue; if (M = I.startValue + A * P(g, d, A), !p && M === I.currentValue) continue }
            ...
            function c(t, e) {
                ...
                for (var i = v.State.calls[t][0], o = v.State.calls[t][1], r = v.State.calls[t][2], s = v.State.calls[t][4], l = !1, c = 0, d = i.length; d > c; c++) {
                    ...
                    s && !0 !== r.loop && s(o), a(h) && !0 === r.loop && !e && (u.each(a(h).tweensContainer, function(t, e) { /^rotate/.test(t) && 360 === parseFloat(e.endValue) && (e.endValue = 0, e.startValue = 360), /^backgroundPosition/.test(t) && 100 === parseFloat(e.endValue) && "%" === e.unitType && (e.endValue = 0, e.startValue = 100) }), v(h, "reverse", { loop: !0, delay: r.delay })), !1 !== r.queue && u.dequeue(h, r.queue)
                }
                v.State.calls[t] = !1;
            ...
            if (!(7 >= d)) {
                ...
                ], function(t, e) { v.Easings[e[0]] = r.apply(null, e[1]) });
                var b = v.CSS = {
                    ...
                    Hooks: {
                        ...
                        getRoot: function(t) { var e = b.Hooks.registered[t]; return e ? e[0] : t },
                        cleanRootPropertyValue: function(t, e) { return b.RegEx.valueUnwrap.test(e) && (e = e.match(b.RegEx.valueUnwrap)[1]), b.Values.isCSSNullValue(e) && (e = b.Hooks.templates[t][1]), e },
                                ...
                                b.Normalizations.registered[e] = function(t, i, o) {
                                    switch (t) {
                                        ...
                                        case "extract":
                                            ...
                                            else { var r, s = { black: "rgb(0, 0, 0)", blue: "rgb(0, 0, 255)", gray: "rgb(128, 128, 128)", green: "rgb(0, 128, 0)", red: "rgb(255, 0, 0)", white: "rgb(255, 255, 255)" }; /^[A-z]+$/i.test(o) ? r = s[o] !== n ? s[o] : s.black : b.RegEx.isHex.test(o) ? r = "rgb(" + b.Values.hexToRgb(o).join(" ") + ")" : /^rgba?\(/i.test(o) || (r = s.black), a = (r || o).toString().match(b.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ") }
                    ...
                    getPropertyValue: function(t, i, o, r) {
                        function s(t, i) {
                            function o() { h && b.setPropertyValue(t, "display", "none") }
                            var l = 0;
                            if (8 >= d) l = u.css(t, i);
                            else {
                                var c, h = !1;
                                if (/^(width|height)$/.test(i) && 0 === b.getPropertyValue(t, "display") && (h = !0, b.setPropertyValue(t, "display", b.Values.getDisplayType(t))), !r) { if ("height" === i && "border-box" !== b.getPropertyValue(t, "boxSizing").toString().toLowerCase()) { var f = t.offsetHeight - (parseFloat(b.getPropertyValue(t, "borderTopWidth")) || 0) - (parseFloat(b.getPropertyValue(t, "borderBottomWidth")) || 0) - (parseFloat(b.getPropertyValue(t, "paddingTop")) || 0) - (parseFloat(b.getPropertyValue(t, "paddingBottom")) || 0); return o(), f } if ("width" === i && "border-box" !== b.getPropertyValue(t, "boxSizing").toString().toLowerCase()) { var p = t.offsetWidth - (parseFloat(b.getPropertyValue(t, "borderLeftWidth")) || 0) - (parseFloat(b.getPropertyValue(t, "borderRightWidth")) || 0) - (parseFloat(b.getPropertyValue(t, "paddingLeft")) || 0) - (parseFloat(b.getPropertyValue(t, "paddingRight")) || 0); return o(), p } }
                        ...
                        } else if (b.Normalizations.registered[i]) { var f, p; "transform" !== (f = b.Normalizations.registered[i]("name", t)) && (p = s(t, b.Names.prefixCheck(f)[0]), b.Values.isCSSNullValue(p) && b.Hooks.templates[i] && (p = b.Hooks.templates[i][1])), l = b.Normalizations.registered[i]("extract", t, p) }
                        if (!/^[\d-]/.test(l))
                    ...
                    setPropertyValue: function(t, i, n, o, r) {
                        ...
                        if ("scroll" === i) r.container ? r.container["scroll" + r.direction] = n : "Left" === r.direction ? e.scrollTo(n, r.alternateValue) : e.scrollTo(r.alternateValue, n);
                            ...
                            if (b.Normalizations.registered[i] && (n = b.Normalizations.registered[i]("inject", t, n), i = b.Normalizations.registered[i]("name", t)), s = b.Names.prefixCheck(i)[0], 8 >= d) try { t.style[s] = n } catch (t) { v.debug && console.log("Browser does not support [" + n + "] for [" + s + "]") } else a(t) && a(t).isSVG && b.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[s] = n;
                            v.debug >= 2 && console.log("Set " + i + " (" + s + "): " + n)
                        }
                        return [s, n]
                    },
                    flushTransformCache: function(t) {
                        function e(e) { return parseFloat(b.getPropertyValue(t, e)) }
                        var i = "";
                ...
                b.Hooks.register(), b.Normalizations.register(), v.hook = function(t, e, i) {
                    ...
                    return t = o(t), u.each(t, function(t, o) {
                        ...
                        else { var s = v.CSS.setPropertyValue(o, e, i); "transform" === s[0] && v.CSS.flushTransformCache(o), r = s }
                    }), r
                };
                var x = function() {
                    ...
                    function r() {
                            ...
                            if ("scroll" === M) {
                                ...
                                for (var O in a(r).tweensContainer && !0 === a(r).isAnimating && (D = a(r).tweensContainer), u.each(y, function(t, e) {
                                    ...
                                    if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                                        ...
                                        var B, j, Y, $ = !1;
                                        if (N = (B = p(O, N))[0], Y = B[1], W = (B = p(O, W))[0].replace(/^([+-\/*])=/, function(t, e) { return $ = e, "" }), j = B[1], N = parseFloat(N) || 0, W = parseFloat(W) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (W /= 100, j = "em") : /^scale/.test(O) ? (W /= 100, j = "") : /(Red|Green|Blue)$/i.test(O) && (W = W / 100 * 255, j = "")), /[\/*]/.test($)) j = Y;
                                        else if (Y !== j && 0 !== N)
                                            if (0 === W) j = Y;
                                            else {
                                                o = o || m();
                                        ...
                                        d[O] = { rootPropertyValue: V, startValue: N, currentValue: N, endValue: W, unitType: j, easing: H }, v.debug && console.log("tweensContainer (" + O + "): " + JSON.stringify(d[O]), r)
                        ...
                        var o, r = this,
                            ...
                            d = {};
                        switch (a(r) === n && v.init(r), parseFloat(c.delay) && !1 !== c.queue && u.queue(r, c.queue, function(t) { v.velocityQueueEntryFlag = !0, a(r).delayTimer = { setTimeout: setTimeout(t, parseFloat(c.delay)), next: t } }), c.duration.toString().toLowerCase()) {
                            case "fast":
                                c.duration = 200;
                                break;
                            case "normal":
                    ...
                    if (f.isWrapped(this) ? (d = !1, p = 0, g = this, h = this) : (d = !0, p = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
                        ...
                        var C = g.length,
                            S = 0;
                        if (!/^(stop|finish)$/i.test(y) && !u.isPlainObject(w)) { w = {}; for (var T = p + 1; T < arguments.length; T++) f.isArray(arguments[T]) || !/^(fast|normal|slow)$/i.test(arguments[T]) && !/^\d/.test(arguments[T]) ? f.isString(arguments[T]) || f.isArray(arguments[T]) ? w.easing = arguments[T] : f.isFunction(arguments[T]) && (w.complete = arguments[T]) : w.duration = arguments[T] }
                        var M, I = { promise: null, resolver: null, rejecter: null };
                        switch (d && v.Promise && (I.promise = new v.Promise(function(t, e) { I.resolver = t, I.rejecter = e })), y) {
                            case "scroll":
                                M = "scroll";
                                break;
                            case "reverse":
                        ...
                        var E, O, L = { lastParent: null, lastPosition: null, lastFontSize: null, lastPercentToPxWidth: null, lastPercentToPxHeight: null, lastEmToPx: null, remToPx: null, vwToPx: null, vhToPx: null },
                            F = [];
                        if (u.each(g, function(t, e) { f.isNode(e) && r.call(e) }), (O = u.extend({}, v.defaults, w)).loop = parseInt(O.loop), E = 2 * O.loop - 1, O.loop)
                            for (var R = 0; E > R; R++) {
                                var W = { delay: O.delay, progress: O.progress };
                ...
                return v.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function() { i.hidden ? (w = function(t) { return setTimeout(function() { t(!0) }, 16) }, l()) : w = e.requestAnimationFrame || h }), t.Velocity = v, t !== e && (t.fn.velocity = x, t.fn.velocity.defaults = v.defaults), u.each(["Down", "Up"], function(t, e) {
                    ...
                    v.Redirects["fade" + e] = function(t, i, o, a, r, s) {
                        var l = u.extend({}, i),
                            c = { opacity: "In" === e ? 1 : 0 },
                            d = l.complete;
                        l.complete = o !== a - 1 ? l.begin = null : function() { d && d.call(r, r), s && s.resolver(r) }, l.display === n && (l.display = "In" === e ? "auto" : "none"), v(this, c, l)
                    }
                }), v
            }
        ...
        return function t(e, i, n) {
                ...
                n._set("bar", { hover: { mode: "label" }, scales: { xAxes: [{ type: "category", categoryPercentage: .8, barPercentage: .9, offset: !0, gridLines: { offsetGridLines: !0 } }], yAxes: [{ type: "linear" }] } }), n._set("horizontalBar", { hover: { mode: "index", axis: "y" }, scales: { xAxes: [{ type: "linear", position: "bottom" }], yAxes: [{ position: "left", type: "category", categoryPercentage: .8, barPercentage: .9, offset: !0, gridLines: { offsetGridLines: !0 } }] }, elements: { rectangle: { borderSkipped: "left" } }, tooltips: { callbacks: { title: function(t, e) { var i = ""; return t.length > 0 && (t[0].yLabel ? i = t[0].yLabel : e.labels.length > 0 && t[0].index < e.labels.length && (i = e.labels[t[0].index])), i }, label: function(t, e) { return (e.datasets[t.datasetIndex].label || "") + ": " + t.xLabel } }, mode: "index", axis: "y" } }), e.exports = function(t) {
                    t.controllers.bar = t.DatasetController.extend({
                        ...
                        getRuler: function() {
                            ...
                            return { pixels: a, start: s, end: l, stackCount: n, scale: i }
                        },
                ...
                n._set("bubble", {
                    ...
                    t.controllers.bubble = t.DatasetController.extend({
                        ...
                        updateElement: function(t, e, i) {
                            ...
                            t._xScale = r, t._yScale = s, t._options = l, t._datasetIndex = u, t._index = e, t._model = { backgroundColor: l.backgroundColor, borderColor: l.borderColor, borderWidth: l.borderWidth, hitRadius: l.hitRadius, pointStyle: l.pointStyle, radius: i ? 0 : l.radius, skip: a.skip || isNaN(d) || isNaN(h), x: d, y: h }, t.pivot()
                        },
                        setHoverStyle: function(t) {
                            var e = t._model,
                                i = t._options;
                ...
                n._set("doughnut", {
                    ...
                    t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                        ...
                        updateElement: function(t, e, i) {
                            ...
                            a.extend(t, { _datasetIndex: n.index, _index: e, _model: { x: c + o.offsetX, y: u + o.offsetY, startAngle: d, endAngle: h, circumference: p, outerRadius: g, innerRadius: m, label: v(f.label, e, o.data.labels[e]) } });
                            var y = t._model;
                    ...
                    t.controllers.line = t.DatasetController.extend({
                        ...
                        update: function(t) {
                            var i, n, o, r = this,
                                ...
                                f = r.getDataset(),
                                p = e(f, u);
                            for (p && (o = l.custom || {}, void 0 !== f.tension && void 0 === f.lineTension && (f.lineTension = f.tension), l._scale = h, l._datasetIndex = r.index, l._children = c, l._model = { spanGaps: f.spanGaps ? f.spanGaps : u.spanGaps, tension: o.tension ? o.tension : a.valueOrDefault(f.lineTension, d.tension), backgroundColor: o.backgroundColor ? o.backgroundColor : f.backgroundColor || d.backgroundColor, borderWidth: o.borderWidth ? o.borderWidth : f.borderWidth || d.borderWidth, borderColor: o.borderColor ? o.borderColor : f.borderColor || d.borderColor, borderCapStyle: o.borderCapStyle ? o.borderCapStyle : f.borderCapStyle || d.borderCapStyle, borderDash: o.borderDash ? o.borderDash : f.borderDash || d.borderDash, borderDashOffset: o.borderDashOffset ? o.borderDashOffset : f.borderDashOffset || d.borderDashOffset, borderJoinStyle: o.borderJoinStyle ? o.borderJoinStyle : f.borderJoinStyle || d.borderJoinStyle, fill: o.fill ? o.fill : void 0 !== f.fill ? f.fill : d.fill, steppedLine: o.steppedLine ? o.steppedLine : a.valueOrDefault(f.steppedLine, d.stepped), cubicInterpolationMode: o.cubicInterpolationMode ? o.cubicInterpolationMode : a.valueOrDefault(f.cubicInterpolationMode, d.cubicInterpolationMode) }, l.pivot()), i = 0, n = c.length; i < n; ++i) r.updateElement(c[i], i, t);
                ...
                n._set("polarArea", {
                    ...
                    t.controllers.polarArea = t.DatasetController.extend({
                        ...
                        updateElement: function(t, e, i) {
                            ...
                            a.extend(t, { _datasetIndex: n.index, _index: e, _scale: c, _model: { x: h, y: f, innerRadius: 0, outerRadius: i ? w : y, startAngle: i && l.animateRotate ? v : b, endAngle: i && l.animateRotate ? v : x, label: a.valueAtIndexOrDefault(u, e, u[e]) } }), n.removeHoverStyle(t), t.pivot()
                        },
                        removeHoverStyle: function(e) { t.DatasetController.prototype.removeHoverStyle.call(this, e, this.chart.options.elements.arc) },
            ...
            22: [function(t, e, i) {
                ...
                var n = t(25),
                    o = t(26),
                    a = t(45);
                n._set("global", { animation: { duration: 1e3, easing: "easeOutQuart", onProgress: a.noop, onComplete: a.noop } }), e.exports = function(t) {
                    t.Animation = o.extend({ chart: null, currentStep: 0, numSteps: 60, easing: "", render: null, onAnimationProgress: null, onAnimationComplete: null }), t.animationService = {
                        frameDuration: 17,
                        animations: [],
                        dropFrames: 0,
                        request: null,
                        ...
                        advance: function(t) { for (var e, i, n = this.animations, o = 0; o < n.length;) i = (e = n[o]).chart, e.currentStep = (e.currentStep || 0) + t, e.currentStep = Math.min(e.currentStep, e.numSteps), a.callback(e.render, [i, e], i), a.callback(e.onAnimationProgress, [e], i), e.currentStep >= e.numSteps ? (a.callback(e.onAnimationComplete, [e], i), i.animating = !1, n.splice(o, 1)) : ++o }
                ...
                e.exports = function(t) {
                    ...
                    t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, {
                        construct: function(e, i) {
                            var a = this;
                            i = function(t) { var e = (t = t || {}).data = t.data || {}; return e.datasets = e.datasets || [], e.labels = e.labels || [], t.options = o.configMerge(n.global, n[t.type], t.options || {}), t }(i);
                            var s = r.acquireContext(e, i),
                                l = s && s.canvas,
                                c = l && l.height,
                                u = l && l.width;
                            a.id = o.uid(), a.ctx = s, a.canvas = l, a.config = i, a.width = u, a.height = c, a.aspectRatio = c ? u / c : null, a.options = i.options, a._bufferedRender = !1, a.chart = a, a.controller = a, t.instances[a.id] = a, Object.defineProperty(a, "data", { get: function() { return a.config.data }, set: function(t) { a.config.data = t } }), s && l ? (a.initialize(), a.update()) : console.error("Failed to create chart: can't acquire context from the given item")
                        },
                        initialize: function() { var t = this; return e.notify(t, "beforeInit"), o.retinaScale(t, t.options.devicePixelRatio), t.bindEvents(), t.options.responsive && t.resize(!0), t.ensureScalesHaveIDs(), t.buildScales(), t.initToolTip(), e.notify(t, "afterInit"), t },
                        ...
                        buildScales: function() {
                            var e = this,
                                ...
                                a = e.scales = {},
                                r = [];
                            n.scales && (r = r.concat((n.scales.xAxes || []).map(function(t) { return { options: t, dtype: "category", dposition: "bottom" } }), (n.scales.yAxes || []).map(function(t) { return { options: t, dtype: "linear", dposition: "left" } }))), n.scale && r.push({ options: n.scale, dtype: "radialLinear", isDefault: !0, dposition: "chartArea" }), o.each(r, function(n) {
                                var r = n.options,
                        ...
                        render: function(i) {
                            ...
                            if (!1 !== e.notify(n, "beforeRender")) {
                                var s = n.options.animation,
                                    l = function(t) { e.notify(n, "afterRender"), o.callback(s && s.onComplete, [t], n) };
                        ...
                        draw: function(t) {
                            var i = this;
                            i.clear(), o.isNullOrUndef(t) && (t = 1), i.transition(t), !1 !== e.notify(i, "beforeDraw", [t]) && (o.each(i.boxes, function(t) { t.draw(i.chartArea) }, i), i.scale && i.scale.draw(), i.drawDatasets(t), i._drawTooltip(t), e.notify(i, "afterDraw", [t]))
                        },
                        ...
                        drawDataset: function(t, i) {
                            var n = this.getDatasetMeta(t),
                                o = { meta: n, index: t, easingValue: i };
                        ...
                        bindEvents: function() {
                            ...
                            o.each(t.options.events, function(n) { r.addEventListener(t, n, i), e[n] = i }), t.options.responsive && (i = function() { t.resize() }, r.addEventListener(t, "resize", i), e.resize = i)
                        },
                        unbindEvents: function() {
                            var t = this,
                                e = t._listeners;
                            e && (delete t._listeners, o.each(e, function(e, i) { r.removeEventListener(t, i, e) }))
                        },
                            ...
                            for (a = 0, r = p.length; a < r; ++a)
                                if (u = i[s = p[a]], e.hasOwnProperty(s) || (e[s] = u), (l = e[s]) !== u && "_" !== s[0]) {
                                    if (t.hasOwnProperty(s) || (t[s] = l), (d = typeof u) == typeof(c = t[s]))
                                        if ("string" === d) { if ((h = n(c)).valid && (f = n(u)).valid) { e[s] = f.mix(h, o).rgbString(); continue } } else if ("number" === d && isFinite(c) && isFinite(u)) { e[s] = c + (u - c) * o; continue }
                                    e[s] = u
                                }
            ...
            27: [function(t, e, i) {
                ...
                e.exports = function(t) {
                    ...
                    a.configMerge = function() {
                        ...
                        return { x: i = Math.round((i - s.left - c) / f * r.width / e.currentDevicePixelRatio), y: n = Math.round((n - s.top - u) / p * r.height / e.currentDevicePixelRatio) }
                    }, a.getConstraintWidth = function(t) { return r(t, "max-width", "clientWidth") }, a.getConstraintHeight = function(t) { return r(t, "max-height", "clientHeight") }, a.getMaximumWidth = function(t) {
                        var e = t.parentNode;
                        ...
                        var s = 0;
                        a.each(i, function(e) { void 0 !== e && null !== e && !0 !== a.isArray(e) ? s = a.measureText(t, o, r, s, e) : a.isArray(e) && a.each(e, function(e) { void 0 === e || null === e || a.isArray(e) || (s = a.measureText(t, o, r, s, e)) }) });
                        var l = r.length / 2;
                        if (l > i.length) {
                        ...
                        update: function(t, o, a) {
                            if (t) {
                                ...
                                n.each(h.concat(f, p, m), function(t) {
                                    ...
                                    i ? (e = t.update(t.fullWidth ? v : k, w), C -= e.height) : (e = t.update(x, b), k -= e.width), S.push({ horizontal: i, minSize: e, box: t })
                                });
                                var T = 0,
                                    M = 0,
                                    I = 0,
                                ...
                                var A = l,
                                    ...
                                    _ = u,
                                    E = d;
                                n.each(h.concat(f), N), n.each(h, function(t) { A += t.width }), n.each(f, function(t) { D += t.width }), n.each(p.concat(m), N), n.each(p, function(t) { _ += t.height }), n.each(m, function(t) { E += t.height }), n.each(h.concat(f), function(t) {
                                    var e = n.findNextWhere(S, function(e) { return e.box === t }),
                                        i = { left: 0, right: 0, top: _, bottom: E };
                                    e && t.update(e.minSize.width, C, i)
                                }), A = l, D = c, _ = u, E = d, n.each(h, function(t) { A += t.width }), n.each(f, function(t) { D += t.width }), n.each(p, function(t) { _ += t.height }), n.each(m, function(t) { E += t.height });
                                ...
                                var F = a - _ - E,
                                    R = o - A - D;
                                R === k && F === C || (n.each(h, function(t) { t.height = F }), n.each(f, function(t) { t.height = F }), n.each(p, function(t) { t.fullWidth || (t.width = R) }), n.each(m, function(t) { t.fullWidth || (t.width = R) }), C = F, k = R);
                                var W = l + O,
                                    H = u + L;
                                n.each(h.concat(p), z), W += k, H += C, n.each(f, z), n.each(m, z), t.chartArea = { left: A, top: _, right: A + k, bottom: _ + C }, n.each(g, function(e) { e.left = t.chartArea.left, e.top = t.chartArea.top, e.right = t.chartArea.right, e.bottom = t.chartArea.bottom, e.update(k, C) })
                            }
                            ...
                            function N(t) {
                                ...
                                if (e)
                                    if (t.isHorizontal()) {
                                        var i = { left: Math.max(A, T), right: Math.max(D, M), top: 0, bottom: 0 };
                                        t.update(t.fullWidth ? v : k, y / 2, i)
                                    } else t.update(e.minSize.width, C)
                            }

                            function z(t) { t.isHorizontal() ? (t.left = t.fullWidth ? l : A, t.right = t.fullWidth ? o - c : A + k, t.top = H, t.bottom = H + t.height, H = t.bottom) : (t.left = W, t.right = W + t.width, t.top = _, t.bottom = _ + C, W = t.right) }
                        }
                    }
                }
            }, { 45: 45 }],
                        ...
                        calculateTickRotation: function() {
                            ...
                            if (o.length && t.options.display && t.isHorizontal())
                                for (var c, u = a.longestText(e, r.font, o, t.longestTextCache), d = u, h = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; d > h && l < n.maxRotation;) {
                                    var f = a.toRadians(l);
                                    if (c = Math.cos(f), Math.sin(f) * u > t.maxHeight) { l--; break }
                                    l++, d = c * u
                                }
                            t.labelRotation = l
                        },
                            ...
                            if (o.display) {
                                ...
                                if (a.each(g, function(i, n) {
                                        if (!a.isNullOrUndef(i.label)) {
                                            ...
                                            M.push({ tx1: v, ty1: y, tx2: b, ty2: x, x1: k, y1: C, x2: S, y2: _, labelX: E, labelY: O, glWidth: r, glColor: s, glBorderDash: d, glBorderDashOffset: f, rotation: -1 * T, label: L, major: i.major, textBaseline: R, textAlign: F })
                                        }
                                    }), a.each(M, function(t) {
                ...
                e.exports = {
                    generators: {
                        ...
                        logarithmic: function(t, e) {
                            ...
                            do { a.push(s), 10 === ++o && (o = 1, ++i), s = o * Math.pow(10, i) } while (i < l || i === l && o < c);
                            var u = r(t.max, s);
                            return a.push(u), a
                        }
                    },
            ...
            35: [function(t, e, i) {
                ...
                n._set("global", {
                    ...
                    t.Tooltip = o.extend({
                        initialize: function() { this._model = r(this._options), this._lastActive = [] },
                        getTitle: function() {
                            ...
                            if (m.length) {
                                ...
                                h.filter && (C = C.filter(function(t) { return h.filter(t, g) })), h.itemSort && (C = C.sort(function(t, e) { return h.itemSort(t, e, g) })), a.each(C, function(t) { w.push(h.callbacks.labelColor.call(d, t, d._chart)), k.push(h.callbacks.labelTextColor.call(d, t, d._chart)) }), p.title = d.getTitle(C, g), p.beforeBody = d.getBeforeBody(C, g), p.body = d.getBody(C, g), p.afterBody = d.getAfterBody(C, g), p.footer = d.getFooter(C, g), p.x = Math.round(x.x), p.y = Math.round(x.y), p.caretPadding = h.caretPadding, p.labelColors = w, p.labelTextColors = k, p.dataPoints = C, y = function(t, e, i) {
                                    var n = t.x,
                                        ...
                                        u = a + r,
                                        d = s + r;
                                    return "right" === l ? n -= e.width : "center" === l && (n -= e.width / 2), "top" === c ? o += u : o -= "bottom" === c ? e.height + u : e.height / 2, "center" === c ? "left" === l ? n += u : "right" === l && (n -= u) : "left" === l ? n -= d : "right" === l && (n += d), { x: n, y: o }
                                }(p, b = function(t, e) {
                                    var i = t._chart.ctx,
                                        n = 2 * e.yPadding,
                                        o = 0,
                                    ...
                                    var h = (c.left + c.right) / 2,
                                        f = (c.top + c.bottom) / 2;
                                    "center" === d ? (i = function(t) { return t <= h }, n = function(t) { return t > h }) : (i = function(t) { return t <= e.width / 2 }, n = function(t) { return t >= l.width - e.width / 2 }), o = function(t) { return t + e.width > l.width }, a = function(t) { return t - e.width < 0 }, r = function(t) { return t <= f ? "top" : "bottom" }, i(s.x) ? (u = "left", o(s.x) && (u = "center", d = r(s.y))) : n(s.x) && (u = "right", a(s.x) && (u = "center", d = r(s.y)));
                                    var p = t._options;
            ...
            39: [function(t, e, i) {
                ...
                n._set("global", { elements: { rectangle: { backgroundColor: n.global.defaultColor, borderColor: n.global.defaultColor, borderSkipped: "bottom", borderWidth: 0 } } }), e.exports = o.extend({
                    draw: function() {
                        ...
                        function y(t) { return g[(v + t) % 4] } - 1 === v && (v = 0);
                        var b = y(0);
                        s.moveTo(b[0], b[1]);
            ...
            47: [function(t, e, i) {
                ...
                function m(t, e, i) {
                    var c, u, d, f, m = t[o] || (t[o] = {}),
                        ...
                        }((c = function() { if (m.resizer) return e(p("resize", i)) }, d = !1, f = [], function() { f = Array.prototype.slice.call(arguments), u = u || this, d || (d = !0, n.requestAnimFrame.call(window, function() { d = !1, c.apply(u, f) })) }));
                    ! function(t, e) {
                        var i = t[o] || (t[o] = {}),
                ...
                function g(t) {
                    ...
                    delete e.resizer,
                        function(t) {
                            var e = t[o] || {},
                                i = e.renderProxy;
                            i && (n.each(l, function(e) { f(t, e, i) }), delete e.renderProxy), t.classList.remove(r)
            ...
            49: [function(t, e, i) {
                ...
                n._set("global", { plugins: { filler: { propagate: !0 } } }), e.exports = function() {
                    ...
                    function i(t) {
                        ...
                        if ("start" === o ? a = void 0 === i.scaleBottom ? n.bottom : i.scaleBottom : "end" === o ? a = void 0 === i.scaleTop ? n.top : i.scaleTop : void 0 !== i.scaleZero ? a = i.scaleZero : n.getBasePosition ? a = n.getBasePosition() : n.getBasePixel && (a = n.getBasePixel()), void 0 !== a && null !== a) { if (void 0 !== a.x && void 0 !== a.y) return a; if ("number" == typeof a && isFinite(a)) return { x: (e = n.isHorizontal()) ? a : null, y: e ? null : a } }
                        return null
                    }
                    ...
                    function c(t, e, i, n, o) { var r; if (n && o) { for (t.moveTo(e[0].x, e[0].y), r = 1; r < n; ++r) a.canvas.lineTo(t, e[r - 1], e[r]); for (t.lineTo(i[o - 1].x, i[o - 1].y), r = o - 1; r > 0; --r) a.canvas.lineTo(t, i[r], i[r - 1], !0) } }
                    return {
                        id: "filler",
                        afterDatasetsUpdate: function(t, n) {
                            var a, l, c, u, d = (t.data.datasets || []).length,
                                h = n.propagate,
                                f = [];
                            for (l = 0; l < d; ++l) u = null, (c = (a = t.getDatasetMeta(l)).dataset) && c._model && c instanceof o.Line && (u = { visible: t.isDatasetVisible(l), fill: e(c, l, d), chart: t, el: c }), a.$filler = u, f.push(u);
            ...
            50: [function(t, e, i) {
                ...
                n._set("global", {
                    ...
                    function r(t, e) { return t.usePointStyle ? e * Math.SQRT2 : t.boxWidth }

                    function s(i, n) {
                        var o = new t.Legend({ ctx: i.ctx, options: n, chart: i });
                            ...
                            if (g ? (m.width = t.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = t.maxHeight), o)
                                if (s.font = f, g) {
                                    ...
                                    s.textAlign = "left", s.textBaseline = "top", a.each(t.legendItems, function(e, n) {
                                        ...
                                        v[v.length - 1] + o + i.padding >= t.width && (y += u + i.padding, v[v.length] = t.left), p[n] = { left: 0, top: 0, width: o, height: u }, v[v.length - 1] += o + i.padding
                                    }), m.height += y
                                } else {
                                    var b = i.padding,
                                        x = t.columnWidths = [],
                                    ...
                                    a.each(t.legendItems, function(t, e) {
                                        ...
                                        C + S > m.height && (w += k + i.padding, x.push(k), k = 0, C = 0), k = Math.max(k, n), C += S, p[e] = { left: 0, top: 0, width: n, height: u }
                        ...
                        draw: function() {
                            ...
                            if (e.display) {
                                ...
                                var y = r(i, p),
                                    b = t.legendHitBoxes,
                                    x = t.isHorizontal();
                                u = x ? { x: t.left + (l - c[0]) / 2, y: t.top + i.padding, line: 0 } : { x: t.left + i.padding, y: t.top + i.padding, line: 0 };
                                var w = p + i.padding;
            ...
            51: [function(t, e, i) {
                ...
                n._set("global", { title: { display: !1, fontStyle: "bold", fullWidth: !0, lineHeight: 1.2, padding: 10, position: "top", text: "", weight: 2e3 } }), e.exports = function(t) {
                    ...
                    function r(i, n) {
                        var o = new t.Title({ ctx: i.ctx, options: n, chart: i });
            ...
            53: [function(t, e, i) {
                ...
                var n = t(25),
                    ...
                    a = t(34);
                e.exports = function(t) {
                    var e = { position: "left", ticks: { callback: a.formatters.linear } },
            ...
            56: [function(t, e, i) {
                ...
                e.exports = function(t) {
                    ...
                    function h(t) { return o.isNumber(t) ? t : 0 }
                    var f = t.LinearScaleBase.extend({
                        ...
                        fit: function() {
                            ...
                            this.options.pointLabels.display ? function(t) {
                                ...
                                var h, f, p, m = r(t);
                                for (e = 0; e < m; e++) {
                                    n = t.getPointPosition(e, c), h = t.ctx, f = a.size, p = t.pointLabels[e] || "", i = o.isArray(p) ? { w: o.longestText(h, h.font, p), h: p.length * f + 1.5 * (p.length - 1) * f } : { w: h.measureText(p).width, h: f }, t._pointLabelSizes[e] = i;
                        ...
                        getIndexAngle: function(t) { return t * (2 * Math.PI / r(this)) + (this.chart.options && this.chart.options.startAngle ? this.chart.options.startAngle : 0) * Math.PI * 2 / 360 },
                ...
                e.exports = function(t) {
                    var e = t.Scale.extend({
                        ...
                        determineDataLimits: function() {
                            ...
                            x.length && (x = d(x).sort(u), g = Math.min(g, x[0]), v = Math.max(v, x[x.length - 1])), y.length && (y = d(y).sort(u), g = Math.min(g, y[0]), v = Math.max(v, y[y.length - 1])), g = p(m.min, h) || g, v = p(m.max, h) || v, g = g === s ? +n().startOf("day") : g, v = v === r ? +n().endOf("day") + 1 : v, h.min = Math.min(g, v), h.max = Math.max(g + 1, v), h._horizontal = h.isHorizontal(), h._table = [], h._timestamps = { data: y, datasets: b, labels: x }
                        },
                        buildTicks: function() {
                            var t, e, i, o = this,
                                a = o.min,
                            ...
                            return o.min = a, o.max = r, o._unit = u.unit || function(t, e, i, o) {
                                    ...
                                    var a, r, s = 0,
                                        l = 0;
                                    return o.offset && e.length && (o.time.min || (a = e.length > 1 ? e[1] : n, r = e[0], s = (h(t, "time", a, "pos") - h(t, "time", r, "pos")) / 2), o.time.max || (a = e[e.length - 1], r = e.length > 1 ? e[e.length - 2] : i, l = (h(t, "time", a, "pos") - h(t, "time", r, "pos")) / 2)), { left: s, right: l }
                                }(o._table, f, a, r, s),
                                function(t, e) { var i, o, a, r, s = []; for (i = 0, o = t.length; i < o; ++i) a = t[i], r = !!e && a === +n(a).startOf(e), s.push({ value: a, major: r }); return s }(f, o._majorUnit)
                        },
                        getLabelForIndex: function(t, e) {
...
$(window).scroll(function() { $(".navbar").length && ($(".navbar").offset().top > OFFSET_TOP ? $(".scrolling-navbar").addClass("top-nav-collapse") : $(".scrolling-navbar").removeClass("top-nav-collapse")) }),
    function(t, e) { "use strict"; "function" == typeof define && define.amd ? define([], function() { return e.apply(t) }) : "object" == typeof exports ? module.exports = e.call(t) : t.Waves = e.call(t) }("object" == typeof global ? global : this, function() {
        ...
        var l = {
                ...
                hide: function(t, e) { for (var i = (e = e || this).getElementsByClassName("waves-rippling"), n = 0, o = i.length; n < o; n++) u(t, e, i[n]) }
            },
            c = {
                input: function(t) {
                    var e = t.parentNode;
            ...
            if (null !== e) {
                ...
                if (d.registerEvent(t), "touchstart" === t.type && l.delay) {
                    var i = !1,
                        ...
                        a = function(n) { o && (clearTimeout(o), o = null, l.show(t, e)), i || (i = !0, l.hide(n, e)) };
                    e.addEventListener("touchmove", function(t) { o && (clearTimeout(o), o = null), a(t) }, !1), e.addEventListener("touchend", a, !1), e.addEventListener("touchcancel", a, !1)
    ...
    function(t) {
        t(document).ready(function() {
            ...
            if (t(e).each(function(e, n) {
                ...
                var a;
                a = window.attachEvent ? function(t, e, i) { t.attachEvent("on" + e, i) } : function(t, e, i) { t.addEventListener(e, i, !1) }, t(".md-textarea-auto").each(function() {
                    var t = this;
    ...
    }(jQuery), $(document).ready(function() { $("#preloader-markup").load("mdb-addons/preloader.html", function() { $(window).on("load", function() { $("#mdb-preloader").fadeOut("slow") }) }) }),
    function(t) {
        t(document).ready(function() {
            t(document).on("click.card", ".card", function(e) {
                ...
                if (i.find(".card-reveal").length) {
                    ...
                    o || a ? i.find(".card-reveal").velocity({ translateY: 0 }, { duration: 225, queue: !1, easing: "easeInOutQuad", complete: function() { t(this).css({ display: "none" }) } }) : (r || s) && i.find(".card-reveal").css({ display: "block" }).velocity("stop", !1).velocity({ translateY: "-100%" }, { duration: 300, queue: !1, easing: "easeInOutQuad" })
                }
    ...
    }(jQuery), $(document).ready(function(t) { t(".card-share > a").on("click", function(e) { e.preventDefault(), t(this).parent().find("div").toggleClass("social-reveal-active"), t(this).toggleClass("share-expanded") }) }),
    function(t) {
        function e() {
            ...
            return function() {
                ...
                function u(i) {
                    ...
                    if (void 0 !== i.optionsOverride && (a = t.extend(a, i.optionsOverride), r = i.optionsOverride.iconClass || r), ! function(t, e) {
                        ...
                        return i.iconClass && u.addClass(a.toastClass).addClass(r), i.title && (f.append(i.title).addClass(a.titleClass), u.append(f)), i.message && (p.append(i.message).addClass(a.messageClass), u.append(p)), a.closeButton && (g.addClass("toast-close-button").attr("role", "button"), u.prepend(g)), a.progressBar && (m.addClass("toast-progress"), u.prepend(m)), a.newestOnTop ? e.prepend(u) : e.append(u), u.hide(), u[a.showMethod]({ duration: a.showDuration, easing: a.showEasing, complete: a.onShown }), a.timeOut > 0 && (l = setTimeout(b, a.timeOut), v.maxHideTime = parseFloat(a.timeOut), v.hideEta = (new Date).getTime() + v.maxHideTime, a.progressBar && (v.intervalId = setInterval(k, 10))),
                            function() {
                                ...
                                a.onclick && u.click(function() { a.onclick(), b() })
...
$(".smooth-scroll").on("click", "a", function() {
        ...
        if ("undefined" !== (void 0 === t ? "undefined" : _typeof(t)) && 0 == t.indexOf("#")) {
            ...
            return $("body,html").animate({ scrollTop: $(t).offset().top - e }, SMOOTH_SCROLL_DURATION), "undefined" !== (void 0 === i ? "undefined" : _typeof(i)) && !1 !== i && history.replaceState(null, null, t), !1
        }
    }),
    function(t) {
        t.fn.scrollTo = function(e) { return t(this).scrollTop(t(this).scrollTop() - t(this).offset().top + t(e).offset().top), this }, t.fn.dropdown = function(e) {
            var i = { inDuration: 300, outDuration: 225, constrain_width: !0, hover: !1, gutter: 0, belowOrigin: !1, alignment: "left" };
            this.each(function() {
                var n = t(this),
                    o = t.extend({}, i, e),
                    a = !1,
                ...
                function l(e) {
                    ...
                    else if ("right" === d) { f = n.position().left + n.outerWidth() - r.outerWidth() + (h = -o.gutter) }
                    r.css({ position: "absolute", top: n.position().top + p + m, left: f }), r.stop(!0, !0).css("opacity", 0).slideDown({ queue: !1, duration: o.inDuration, easing: "easeOutCubic", complete: function() { t(this).css("height", "") } }).animate({ opacity: 1, scrollTop: 0 }, { queue: !1, duration: o.inDuration, easing: "easeOutSine" })
                }

                function c() { a = !1, r.fadeOut(o.outDuration), r.removeClass("active"), n.removeClass("active"), setTimeout(function() { r.css("max-height", "") }, o.outDuration) }
                if (s(), n.after(r), o.hover) {
                    var u = !1;
                    n.unbind("click." + n.attr("id")), n.on("mouseenter", function() {!1 === u && (l(), u = !0) }), n.on("mouseleave", function(e) {
                ...
                } else n.unbind("click." + n.attr("id")), n.bind("click." + n.attr("id"), function(e) { a || (n[0] !== e.currentTarget || n.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length ? n.hasClass("active") && (c(), t(document).unbind("click." + r.attr("id") + " touchstart." + r.attr("id"))) : (e.preventDefault(), l("click")), r.hasClass("active") && t(document).bind("click." + r.attr("id") + " touchstart." + r.attr("id"), function(e) { r.is(e.target) || n.is(e.target) || n.find(e.target).length || (c(), t(document).unbind("click." + r.attr("id") + " touchstart." + r.attr("id"))) })) });
                n.on("open", function(t, e) { l(e) }), n.on("close", c)
            })
...
function dropdownEffectEnd(t, e) { t.dropdown.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() { t.dropdown.removeClass("dropdown-animating"), t.dropdownMenu.removeClass("animated"), t.dropdownMenu.removeClass(t.effectIn), t.dropdownMenu.removeClass(t.effectOut), "function" == typeof e && e() }) }
dropdownSelectors.on({
    ...
    function(t) {
        ...
        }), t.fn.extend({ openFAB: function() { e(t(this)) }, closeFAB: function() { i(t(this)) } });
        var e = function(e) {
                var i = e;
                ...
                return e.preventDefault(),
                    function(e) {
                        if ($this = e, !1 === $this.hasClass("active")) {
                            ...
                            var i = 0;
                            $this.find("ul .btn-floating").reverse().each(function() { t(this).velocity({ opacity: "1", scaleX: "1", scaleY: "1", translateY: "0" }, { duration: 80, delay: i }), i += 40 })
                        } else {
    ...
    function(t, e, i, n) {
        ...
        var m = p(function(t, e, i) { for (var o = Object.keys(e), a = 0; a < o.length;)(!i || i && t[o[a]] === n) && (t[o[a]] = e[o[a]]), a++; return t }, "extend", "Use `assign`."),
        ...
        function _(e) { var i = e.ownerDocument || e; return i.defaultView || i.parentWindow || t }
                    ...
                    e.timeStamp = u(), e.deltaTime = e.timeStamp - r.timeStamp, e.angle = nt(l, d), e.distance = it(l, d),
                        function(t, e) {
                            var i = e.center,
                                ...
                                o = t.prevDelta || {},
                                a = t.prevInput || {};
                            e.eventType !== R && a.eventType !== H || (o = t.prevDelta = { x: a.deltaX || 0, y: a.deltaY || 0 }, n = t.offsetDelta = { x: i.x, y: i.y });
        ...
        function et(t, e) { return t === e ? z : c(t) >= c(e) ? t < 0 ? V : B : e < 0 ? j : Y }
        ...
        Z.prototype = { handler: function() {}, init: function() { this.evEl && w(this.element, this.evEl, this.domHandler), this.evTarget && w(this.target, this.evTarget, this.domHandler), this.evWin && w(_(this.element), this.evWin, this.domHandler) }, destroy: function() { this.evEl && k(this.element, this.evEl, this.domHandler), this.evTarget && k(this.target, this.evTarget, this.domHandler), this.evWin && k(_(this.element), this.evWin, this.domHandler) } };
        var ot = { mousedown: R, mousemove: W, mouseup: H },
            at = "mousedown",
            rt = "mousemove mouseup";

        function st() { this.evEl = at, this.evWin = rt, this.pressed = !1, Z.apply(this, arguments) }
        v(st, Z, {
            handler: function(t) {
                var e = ot[t.type];
                e & R && 0 === t.button && (this.pressed = !0), e & W && 1 !== t.which && (e = H), this.pressed && (e & H && (this.pressed = !1), this.callback(this.manager, e, { pointers: [t], changedPointers: [t], pointerType: "mouse", srcEvent: t }))
            }
        });
        var lt = { pointerdown: R, pointermove: W, pointerup: H, pointercancel: N, pointerout: N },
            ct = { 2: "touch", 3: "pen", 4: "mouse", 5: "kinect" },
            ut = "pointerdown",
            dt = "pointermove pointerup pointercancel";

        function ht() { this.evEl = ut, this.evWin = dt, Z.apply(this, arguments), this.store = this.manager.session.pointerEvents = [] }
        t.MSPointerEvent && !t.PointerEvent && (ut = "MSPointerDown", dt = "MSPointerMove MSPointerUp MSPointerCancel"), v(ht, Z, {
            handler: function(t) {
                ...
                o & R && (0 === t.button || r) ? s < 0 && (e.push(t), s = e.length - 1) : o & (H | N) && (i = !0), s < 0 || (e[s] = t, this.callback(this.manager, o, { pointers: e, changedPointers: [t], pointerType: a, srcEvent: t }), i && e.splice(s, 1))
            }
        });
        var ft = { touchstart: R, touchmove: W, touchend: H, touchcancel: N },
            pt = "touchstart",
            mt = "touchstart touchmove touchend touchcancel";

        function gt() { this.evTarget = pt, this.evWin = mt, this.started = !1, Z.apply(this, arguments) }
        v(gt, Z, {
            handler: function(t) {
                var e = ft[t.type];
                if (e === R && (this.started = !0), this.started) {
                    ...
                    e & (H | N) && i[0].length - i[1].length == 0 && (this.started = !1), this.callback(this.manager, e, { pointers: i[0], changedPointers: i[1], pointerType: "touch", srcEvent: t })
                }
            }
        });
        var vt = { touchstart: R, touchmove: W, touchend: H, touchcancel: N },
            yt = "touchstart touchmove touchend touchcancel";

        function bt() { this.evTarget = yt, this.targetIds = {}, Z.apply(this, arguments) }
        v(bt, Z, {
            handler: function(t) {
                var e = vt[t.type],
                    i = function(t, e) {
                        ...
                        var o, a, r = I(t.changedTouches),
                            s = [],
                            l = this.target;
                        if (a = i.filter(function(t) { return C(t.target, l) }), e === R)
        ...
        v(kt, Z, {
            handler: function(t, e, i) {
                ...
                if (!(o && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
                    if (n)(function(t, e) { t & R ? (this.primaryTouch = e.changedPointers[0].identifier, Ct.call(this, e)) : t & (H | N) && Ct.call(this, e) }).call(this, e, i);
        ...
        var St = A(r.style, "touchAction"),
            ...
            _t = function() {
                ...
                return ["auto", "manipulation", "pan-y", "pan-x", "pan-x pan-y", "none"].forEach(function(n) { e[n] = !i || t.CSS.supports("touch-action", n) }), e
            }();

        function Et(t, e) { this.manager = t, this.set(e) }
        Et.prototype = {
            set: function(t) { "compute" == t && (t = this.compute()), Tt && this.manager.element.style && _t[t] && (this.manager.element.style[St] = t), this.actions = t.toLowerCase().trim() },
            update: function() { this.set(this.manager.options.touchAction) },
            compute: function() {
                var t = [];
                return f(this.manager.recognizers, function(e) { b(e.options.enable, [e]) && (t = t.concat(e.getTouchAction())) }),
                    function(t) {
                        if (S(t, Pt)) return Pt;
                        var e = S(t, At),
                            i = S(t, Dt);
        ...
        function Nt(t) { this.options = o({}, this.defaults, t || {}), this.id = D++, this.manager = null, this.options.enable = x(this.options.enable, !0), this.state = Ot, this.simultaneous = {}, this.requireFail = [] }

        function zt(t) { return t & Ht ? "cancel" : t & Rt ? "end" : t & Ft ? "move" : t & Lt ? "start" : "" }

        function Vt(t) { return t == Y ? "down" : t == j ? "up" : t == V ? "left" : t == B ? "right" : "" }

        function Bt(t, e) { var i = e.manager; return i ? i.get(t) : t }

        function jt() { Nt.apply(this, arguments) }

        function Yt() { jt.apply(this, arguments), this.pX = null, this.pY = null }

        function $t() { jt.apply(this, arguments) }

        function Xt() { Nt.apply(this, arguments), this._timer = null, this._input = null }

        function qt() { jt.apply(this, arguments) }

        function Ut() { jt.apply(this, arguments) }

        function Qt() { Nt.apply(this, arguments), this.pTime = !1, this.pCenter = !1, this._timer = null, this._input = null, this.count = 0 }

        function Zt(t, e) { return (e = e || {}).recognizers = x(e.recognizers, Zt.defaults.preset), new Gt(t, e) }
        Nt.prototype = {
            defaults: {},
            set: function(t) { return o(this.options, t), this.manager && this.manager.touchAction.update(), this },
            recognizeWith: function(t) { if (h(t, "recognizeWith", this)) return this; var e = this.simultaneous; return e[(t = Bt(t, this)).id] || (e[t.id] = t, t.recognizeWith(this)), this },
            dropRecognizeWith: function(t) { return h(t, "dropRecognizeWith", this) ? this : (t = Bt(t, this), delete this.simultaneous[t.id], this) },
            requireFailure: function(t) { if (h(t, "requireFailure", this)) return this; var e = this.requireFail; return -1 === M(e, t = Bt(t, this)) && (e.push(t), t.requireFailure(this)), this },
            ...
            attrTest: function(t) { return jt.prototype.attrTest.call(this, t) && (this.state & Lt || !(this.state & Lt) && this.directionTest(t)) },
            emit: function(t) {
            ...
            getTouchAction: function() { return [Pt] },
            attrTest: function(t) { return this._super.attrTest.call(this, t) && (Math.abs(t.scale - 1) > this.options.threshold || this.state & Lt) },
            emit: function(t) {
                if (1 !== t.scale) {
            ...
            process: function(t) {
                ...
                else if (t.eventType & R) this.reset(), this._timer = d(function() { this.state = Wt, this.tryEmit() }, e.time, this);
                else if (t.eventType & H) return Wt;
                return 32
            },
            reset: function() { clearTimeout(this._timer) },
            emit: function(t) { this.state === Wt && (t && t.eventType & H ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = u(), this.manager.emit(this.options.event, this._input))) }
        }), v(qt, jt, { defaults: { event: "rotate", threshold: 0, pointers: 2 }, getTouchAction: function() { return [Pt] }, attrTest: function(t) { return this._super.attrTest.call(this, t) && (Math.abs(t.rotation) > this.options.threshold || this.state & Lt) } }), v(Ut, jt, {
            defaults: { event: "swipe", threshold: 10, velocity: .3, direction: $ | X, pointers: 1 },
            getTouchAction: function() { return Yt.prototype.getTouchAction.call(this) },
            attrTest: function(t) { var e, i = this.options.direction; return i & ($ | X) ? e = t.overallVelocity : i & $ ? e = t.overallVelocityX : i & X && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && c(e) > this.options.velocity && t.eventType & H },
            emit: function(t) {
            ...
            process: function(t) {
                ...
                if (n && o && i) {
                    ...
                    if (this.pTime = t.timeStamp, this.pCenter = t.center, r && a ? this.count += 1 : this.count = 1, this._input = t, 0 === this.count % e.taps) return this.hasRequireFailures() ? (this._timer = d(function() { this.state = Wt, this.tryEmit() }, e.interval, this), Lt) : Wt
                }
                return 32
            },
            failTimeout: function() { return this._timer = d(function() { this.state = 32 }, this.options.interval, this), 32 },
            reset: function() { clearTimeout(this._timer) },
            emit: function() { this.state == Wt && (this._input.tapCount = this.count, this.manager.emit(this.options.event, this._input)) }
        ...
        function Kt(t, e) {
            var i, n = t.element;
            n.style && (f(t.options.cssProps, function(o, a) { i = A(n.style, a), e ? (t.oldCssProps[i] = n.style[i], n.style[i] = o) : n.style[i] = t.oldCssProps[i] || "" }), e || (t.oldCssProps = {}))
        }
        Gt.prototype = {
            ...
            add: function(t) { if (h(t, "add", this)) return this; var e = this.get(t.options.event); return e && this.remove(e), this.recognizers.push(t), t.manager = this, this.touchAction.update(), t },
            remove: function(t) {
            ...
            on: function(t, e) { if (t !== n && e !== n) { var i = this.handlers; return f(T(t), function(t) { i[t] = i[t] || [], i[t].push(e) }), this } },
            off: function(t, e) { if (t !== n) { var i = this.handlers; return f(T(t), function(t) { e ? i[t] && i[t].splice(M(i[t], e), 1) : delete i[t] }), this } },
            emit: function(t, i) {
                ...
                if (n && n.length) { i.type = t, i.preventDefault = function() { i.srcEvent.preventDefault() }; for (var o = 0; o < n.length;) n[o](i), o++ }
            },
            destroy: function() { this.element && Kt(this, !1), this.handlers = {}, this.session = {}, this.input.destroy(), this.element = null }
        }, o(Zt, { INPUT_START: R, INPUT_MOVE: W, INPUT_END: H, INPUT_CANCEL: N, STATE_POSSIBLE: Ot, STATE_BEGAN: Lt, STATE_CHANGED: Ft, STATE_ENDED: Rt, STATE_RECOGNIZED: Wt, STATE_CANCELLED: Ht, STATE_FAILED: 32, DIRECTION_NONE: z, DIRECTION_LEFT: V, DIRECTION_RIGHT: B, DIRECTION_UP: j, DIRECTION_DOWN: Y, DIRECTION_HORIZONTAL: $, DIRECTION_VERTICAL: X, DIRECTION_ALL: q, Manager: Gt, Input: Z, TouchAction: Et, TouchInput: bt, MouseInput: st, PointerEventInput: ht, TouchMouseInput: kt, SingleTouchInput: gt, Recognizer: Nt, AttrRecognizer: jt, Tap: Qt, Pan: Yt, Swipe: Ut, Pinch: $t, Rotate: qt, Press: Xt, on: w, off: k, each: f, merge: g, extend: m, assign: o, inherit: v, bindFn: y, prefixed: A }), (void 0 !== t ? t : "undefined" != typeof self ? self : {}).Hammer = Zt, "function" == typeof define && define.amd ? define(function() { return Zt }) : "undefined" != typeof module && module.exports ? module.exports = Zt : t.Hammer = Zt
    }(window, document),
    function(t) { "function" == typeof define && define.amd ? define(["jquery", "hammerjs"], t) : "object" == typeof exports ? t(require("jquery"), require("hammerjs")) : t(jQuery, Hammer) }(function(t, e) {
        ...
        }, e.Manager.prototype.emit = (i = e.Manager.prototype.emit, function(e, n) { i.call(this, e, n), t(this.element).trigger({ type: e, gesture: n }) })
    });
    ...
    var e = 240,
        ...
        c = function() {
            function c(u, d) {
                ...
                t("body").append(v), "left" === d.edge ? (this.menu_id.css("transform", "translateX(-100%)"), v.css({ left: 0 })) : (this.menu_id.addClass("right-aligned").css("transform", "translateX(100%)"), v.css({ right: 0 })), this.menu_id.hasClass("fixed") && (window.innerWidth > i && this.menu_id.css("transform", "translateX(0)"), t(window).resize(function() { window.innerWidth > i ? t("#sidenav-overlay").length ? h.removeMenu(!0) : h.menu_id.css("transform", "translateX(0%)") : !1 === f && ("left" === d.edge ? h.menu_id.css("transform", "translateX(-100%)") : h.menu_id.css("transform", "translateX(100%)")) })), !0 === this.options.closeOnClick && this.menu_id.on("click", "a:not(.collapsible-header)", function() { h.removeMenu() }), m.click(function(e) {
                    if (e.preventDefault(), !0 === f) f = !1, h.removeMenu();
                    else {
                        var i = t("body"),
                            n = t('<div id="sidenav-overlay"></div>');
                        i.append(n), "left" === h.options.edge ? h.menu_id.velocity({ translateX: [0, -1 * d.MENU_WIDTH] }, { duration: 300, queue: !1, easing: "easeOutQuad" }) : h.menu_id.velocity({ translateX: [0, d.MENU_WIDTH] }, { duration: 300, queue: !1, easing: "easeOutQuad" }), n.click(function() { h.removeMenu() })
                    }
                }), v.click(function() { h.removeMenu() }), v.hammer({ prevent_default: !1 }).bind("pan", function(e) {
                    if ("touch" === e.gesture.pointerType) {
                        ...
                        if (o.css("overflow", "hidden"), o.width(a), 0 === t("#sidenav-overlay").length) {
                            ...
                            r.css("opacity", 0).click(function() { h.removeMenu() }), t("body").append(r)
                        }
                        ...
                        var l = void 0;
                        "left" === d.edge ? (l = i / d.MENU_WIDTH, t("#sidenav-overlay").velocity({ opacity: l }, { duration: 10, queue: !1, easing: "easeOutQuad" })) : (l = Math.abs((i - window.innerWidth) / d.MENU_WIDTH), t("#sidenav-overlay").velocity({ opacity: l }, { duration: 10, queue: !1, easing: "easeOutQuad" }))
                    }
...
function(t) {
    t.fn.collapsible = function(e) {
        ...
        return e = t.extend(i, e), this.each(function() {
            ...
            function l(t) { return t.closest("li > .collapsible-header") }
...
function(t) {
    ...
    t(document).on("change", e, function() {
        ...
        if (!r.length && function() {
                ...
                t(e).after(i)
            }(), r.find(".value").html(a.val()), i = !0, a.addClass("active"), r.hasClass("active") || r.velocity({ height: "30px", width: "30px", top: "-20px", marginLeft: "-15px" }, { duration: 300, easing: "easeOutExpo" }), "input" !== o.type) {
    ...
    }), t(document).on("mouseup touchend", ".range-field", function() { i = !1, t(this).removeClass("active") }), t(document).on("mousemove touchmove", ".range-field", function(n) {
        var o = t(this).children(".thumb"),
            a = void 0;
        if (i) {
            o.hasClass("active") || o.velocity({ height: "30px", width: "30px", top: "-20px", marginLeft: "-15px" }, { duration: 300, easing: "easeOutExpo" }), a = void 0 === n.pageX || null === n.pageX ? n.originalEvent.touches[0].pageX - t(this).offset().left : n.pageX - t(this).offset().left;
...
function(t) {
        ...
        t(this).each(function() {
            ...
            if (!n.hasClass("browser-default")) {
                ...
                if (a && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), t("ul#select-options-" + a).remove()), "destroy" !== e) {
                    var r, s = (r = (new Date).getTime(), "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(t) { var e = (r + 16 * Math.random()) % 16 | 0; return r = Math.floor(r / 16), ("x" == t ? e : 3 & e | 8).toString(16) }));
                    n.data("select-id", s);
                    ...
                    var y = function(e, i, n) {
                        var o = i.is(":disabled") ? "disabled " : "",
                            ...
                            r = i.data("icon"),
                            s = i.attr("class");
                        if (r) { var l = ""; return s && (l = ' class="' + s + '"'), "multiple" === n ? d.append(t('<li class="' + o + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable"><input type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : d.append(t('<li class="' + o + a + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable">' + i.html() + "</span></li>")), !0 }
                    ...
                    h.length && h.each(function() {
                        if (t(this).is("option")) o ? y(0, t(this), "multiple") : y(0, t(this));
                            ...
                            d.append(t('<li class="optgroup"><span>' + t(this).attr("label") + "</span></li>")), e.each(function() { y(0, t(this), "optgroup-option") })
                        }
                    });
                    var b = !1;
                    n.find("optgroup").length && (b = !0);
                    var x = n.parent().find("button.btn-save");
                    x.length && (d.append(x), x.on("click", function() { t("input.select-dropdown").trigger("close") })), d.find("li:not(.optgroup)").each(function(a) {
                        t(this).click(function(r) {
                            if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                                var s = !0;
                                o ? (t('input[type="checkbox"]', this).prop("checked", function(t, e) { return !e }), s = i(f, v ? b ? t(this).index() - t(this).prevAll(".optgroup").length - 1 : t(this).index() - 1 : b ? t(this).index() - t(this).prevAll(".optgroup").length : t(this).index(), n), C.trigger("focus")) : (d.find("li").removeClass("active"), t(this).toggleClass("active"), C.val(t(this).text())), S(d, t(this)), n.find("option").eq(a).prop("selected", s), n.trigger("change"), void 0 !== e && e()
                            }
                            r.stopPropagation()
                        })
                    }), n.wrap(l);
                    ...
                    n.before(C), C.before(w), C.after(d), n.is(":disabled") || C.dropdown({ hover: !1, closeOnClick: !1 }), n.attr("tabindex") && t(C[0]).attr("tabindex", n.attr("tabindex")), n.addClass("initialized"), C.on({
                        focus: function() {
                    ...
                    }), C.on("blur", function() { o || v || t(this).trigger("close"), d.find("li.selected").removeClass("selected") }), !o && v && d.find("li").on("click", function() { C.trigger("close") }), d.hover(function() { p = !0 }, function() { p = !1 }), d.on("mousedown", function(e) { t(".modal-content").find(d).length && this.scrollHeight > this.offsetHeight && e.preventDefault() }), t(window).on({
                        click: function() {
                    ...
                    var S = function(e, i) { i && (e.find("li.selected").removeClass("selected"), t(i).addClass("selected")) },
                        T = [];
                        ...
                        if (9 != e.which)
                            if (40 != e.which || d.is(":visible")) {
                                if (13 != e.which || d.is(":visible")) {
                                    ...
                                    40 == e.which && (a = d.find("li.selected").length ? d.find("li.selected").next("li:not(.disabled)")[0] : d.find("li:not(.disabled)")[0], S(d, a)), 27 == e.which && C.trigger("close"), 38 == e.which && (a = d.find("li.selected").prev("li:not(.disabled)")[0]) && S(d, a), setTimeout(function() { T = [] }, 1e3)
                                }
                            } else C.trigger("open");
...
}(jQuery), jQuery("select").siblings("input.select-dropdown").on("mousedown", function(t) { /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (t.clientX >= t.target.clientWidth || t.clientY >= t.target.clientHeight) && t.preventDefault() }),
    function(t) { "function" == typeof define && define.amd ? define("picker", ["jquery"], t) : "object" == typeof exports ? module.exports = t(require("jquery")) : this.Picker = t(jQuery) }(function(t) {
        ...
        function a(e, l, u, d) {
                ...
                y = v.prototype = {
                    ...
                    start: function() {
                        return f && f.start ? y : (f.methods = {}, f.start = !0, f.open = !1, f.type = e.type, e.autofocus = e == c(), e.readOnly = !p.editable, e.id = e.id || f.id, "text" != e.type && (e.type = "text"), y.component = new u(y, p), y.$root = t('<div class="' + m.picker + '" id="' + e.id + '_root" />'), s(y.$root[0], "hidden", !0), y.$holder = t(b()).appendTo(y.$root), x(), p.formatSubmit && function() {
                            ...
                            y._hidden = t('<input type=hidden name="' + i + '"' + (g.data("value") || e.value ? ' value="' + y.get("select", p.formatSubmit) + '"' : "") + ">")[0], g.on("change." + f.id, function() { y._hidden.value = e.value ? y.get("select", p.formatSubmit) : "" })
                        }(), function() {
                            g.data(l, y).addClass(m.input).val(g.data("value") ? y.get("select", p.format) : e.value), p.editable || g.on("focus." + f.id + " click." + f.id, function(t) { t.preventDefault(), y.open() }).on("keydown." + f.id, k);
                            s(e, { haspopup: !0, expanded: !1, readonly: !1, owns: e.id + "_root" })
                        }(), p.containerHidden ? t(p.containerHidden).append(y._hidden) : g.after(y._hidden), p.container ? t(p.container).append(y.$root) : g.after(y.$root), y.on({ start: y.component.onStart, render: y.component.onRender, stop: y.component.onStop, open: y.component.onOpen, close: y.component.onClose, set: y.component.onSet }).on({ start: p.onStart, render: p.onRender, stop: p.onStop, open: p.onOpen, close: p.onClose, set: p.onSet }), h = function(t) {
                            var e;
                    ...
                    render: function(e) { return e ? (y.$holder = t(b()), x(), y.$root.html(y.$holder)) : y.$root.find("." + m.box).html(y.component.nodes(f.open)), y.trigger("render") },
                    stop: function() { return f.start ? (y.close(), y._hidden && y._hidden.parentNode.removeChild(y._hidden), y.$root.remove(), g.removeClass(m.input).removeData(l), setTimeout(function() { g.off("." + f.id) }, 0), e.type = f.type, e.readOnly = !1, y.trigger("stop"), f.methods = {}, f.start = !1, y) : y },
                    open: function(l) {
                        return f.open ? y : (g.addClass(m.active), s(e, "expanded", !0), setTimeout(function() { y.$root.addClass(m.opened), s(y.$root[0], "hidden", !1) }, 0), !1 !== l && (f.open = !0, h && n.css("overflow", "hidden").css("padding-right", "+=" + r()), h && o ? y.$holder.find("." + m.frame).one("transitionend", function() { y.$holder[0].focus() }) : y.$holder[0].focus(), i.on("click." + f.id + " focusin." + f.id, function(t) {
                            var i = t.target;
                    ...
                    off: function() { var t, e, i = arguments; for (t = 0, namesCount = i.length; t < namesCount; t += 1)(e = i[t]) in f.methods && delete f.methods[e]; return y },
            ...
            function x() {
                y.$holder.on({
                    keydown: k,
                    "focus.toOpen": w,
                    blur: function() { g.removeClass(m.target) },
        ...
        function c() { try { return document.activeElement } catch (t) {} }
        return a.klasses = function(t) { return { picker: t = t || "picker", opened: t + "--opened", focused: t + "--focused", input: t + "__input", active: t + "__input--active", target: t + "__input--target", holder: t + "__holder", frame: t + "__frame", wrap: t + "__wrap", box: t + "__box" } }, a._ = {
            ...
            node: function(e, i, n, o) { return i ? (i = t.isArray(i) ? i.join("") : i, "<" + e + (n = n ? ' class="' + n + '"' : "") + (o = o ? " " + o : "") + ">" + i + "</" + e + ">") : "" },
    ...
    function(t) { "function" == typeof define && define.amd ? define(["picker", "jquery"], t) : "object" == typeof exports ? module.exports = t(require("./picker.js"), require("jquery")) : t(Picker, jQuery) }(function(t, e) {
        ...
        o.prototype.set = function(t, e, i) {
            ...
            return i
        }, o.prototype.normalize = function(t) { return t.setHours(0, 0, 0, 0), t }, o.prototype.measure = function(t, e) { return e ? "string" == typeof e ? e = this.parse(t, e) : n.isInteger(e) && (e = this.now(t, e, { rel: e })) : e = "min" == t ? -1 / 0 : 1 / 0, e }, o.prototype.viewset = function(t, e) { return this.create([e.year, e.month, 1]) }, o.prototype.validate = function(t, i, o) {
            var a, r, s, l, c = this,
                u = i,
    ...
    function() {
        ...
        function S(t, e) {
            ...
            if (e.twelvehour)
                for (E = 0; E < 12; E += e.hourstep) O = R.clone(), L = E / 6 * Math.PI, F = y, O.css("font-size", "140%"), O.css({ left: v + Math.sin(L) * F - x, top: v - Math.cos(L) * F - x }), O.html(0 === E ? 12 : E), f.append(O), O.on(u, N);
            else
                for (E = 0; E < 24; E += e.hourstep) {
                    O = R.clone(), L = E / 6 * Math.PI;
                    var W = E > 0 && E < 13;
                    F = W ? b : y, O.css({ left: v + Math.sin(L) * F - x, top: v - Math.cos(L) * F - x }), W && O.css("font-size", "120%"), O.html(0 === E ? "00" : E), f.append(O), O.on(u, N)
                }
            var H = Math.max(e.minutestep, 5);
            for (E = 0; E < 60; E += H)
                for (E = 0; E < 60; E += 5) O = R.clone(), L = E / 30 * Math.PI, O.css({ left: v + Math.sin(L) * y - x, top: v - Math.cos(L) * y - x }), O.css("font-size", "140%"), O.html(m(E)), S.append(O), O.on(u, N);
            ...
            function N(t, i) {
                ...
                if (!i || !(p < y - x || p > y + x)) {
                    t.preventDefault();
                    var g = setTimeout(function() { D.popover.addClass("clockpicker-moving") }, 200);
                    s && l.append(D.canvas), D.setHand(u, f, !i, !0), a.off(d).on(d, function(t) {
                        ...
                        (i || m) && o === u && s === f && D.setHand(o, s), "hours" === D.currentView ? D.toggleView("minutes", k / 2) : e.autoclose && (D.minutesView.addClass("clockpicker-dial-out"), setTimeout(function() { D.done() }, k / 2)), l.prepend(z), clearTimeout(g), D.popover.removeClass("clockpicker-moving"), a.off(d)
                    })
                }
            }
        ...
        S.DEFAULTS = { default: "", fromnow: 0, donetext: "Done", autoclose: !1, ampmclickable: !1, darktheme: !1, twelvehour: !1, vibrate: !0, hourstep: 1, minutestep: 1, ampmSubmit: !1 }, S.prototype.toggle = function() { this[this.isShown ? "hide" : "show"]() }, S.prototype.locate = function() {
            var t = this.element,
                e = this.popover;
            ...
            if (!this.isShown) {
                ...
                var e = this;
                this.input.blur(), this.popover.addClass("picker--opened"), this.input.addClass("picker__input picker__input--active"), n(document.body).css("overflow", "hidden"), this.isAppended || (this.popover.insertAfter(this.input), this.options.twelvehour && (this.amOrPm = "PM", this.options.ampmclickable ? (this.spanAmPm.children("#click-pm").addClass("text-primary"), this.spanAmPm.children("#click-am").removeClass("text-primary")) : (this.amPmBlock.children(".am-button").removeClass("active"), this.amPmBlock.children(".pm-button").addClass("active"), this.spanAmPm.empty().append("PM"))), o.on("resize.clockpicker" + this.id, function() { e.isShown && e.locate() }), this.isAppended = !0), this.parseInputValue(), this.spanHours.html(m(this.hours)), this.spanMinutes.html(m(this.minutes)), this.options.twelvehour && this.spanAmPm.empty().append(this.amOrPm), this.toggleView("hours"), this.locate(), this.isShown = !0, a.on("click.clockpicker." + this.id + " focusin.clockpicker." + this.id, function(t) {
                    var i = n(t.target);
                    0 === i.closest(e.popover.find(".picker__wrap")).length && 0 === i.closest(e.input).length && e.hide()
                }), a.on("keyup.clockpicker." + this.id, function(t) { 27 === t.keyCode && e.hide() }), T(this.options.afterShow)
            }
        }, S.prototype.hide = function() { T(this.options.beforeHide), this.input.removeClass("picker__input picker__input--active"), this.popover.removeClass("picker--opened"), n(document.body).css("overflow", "visible"), this.isShown = !1, n(":input").each(function(t) { n(this).attr("tabindex", t + 1) }), a.off("click.clockpicker." + this.id + " focusin.clockpicker." + this.id), a.off("keyup.clockpicker." + this.id), this.popover.hide(), T(this.options.afterHide) }, S.prototype.toggleView = function(t, e) {
            var i = !1;
            ...
            this.currentView = t, this.spanHours.toggleClass("text-primary", o), this.spanMinutes.toggleClass("text-primary", !o), r.addClass("clockpicker-dial-out"), a.css("visibility", "visible").removeClass("clockpicker-dial-out"), this.resetClock(e), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function() { r.css("visibility", "hidden") }, k), i && T(this.options.afterHourSelect)
        ...
        }, S.prototype.remove = function() { this.element.removeData("clockpicker"), this.input.off("focus.clockpicker click.clockpicker"), this.isShown && this.hide(), this.isAppended && (o.off("resize.clockpicker" + this.id), this.popover.remove()) }, n.fn.pickatime = function(t) {
    ...
    function(t, e) { "function" == typeof define && define.amd ? define(e) : "object" == typeof exports ? module.exports = e() : t.PhotoSwipe = e() }(this, function() {
        ...
        return function(t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, f, p, m, g, v, y, b, x, w, k, C, S, T, M, I, P, A, D, _, E, O, L, F, R, W, H, N, z, V, B, j, Y, $, X, q, U, Q, Z, G, K, J, tt, et, it, nt, ot, at, rt, st, lt = { x: 0, y: 0 },
                ct = { x: 0, y: 0 },
                ut = { x: 0, y: 0 },
                dt = {},
                ht = 0,
                ...
                Ft = null,
                Rt = function() { Ft && (o.unbind(document, "mousemove", Rt), o.addClass(t, "pswp--has_mouse"), r.mouseUsed = !0, St("mouseUsed")), Ft = setTimeout(function() { Ft = null }, 100) },
                Wt = function(t, e) { var i = $e(a.currItem, dt, t); return e && (J = i), i },
                Ht = function(t) { return t || (t = a.currItem), t.initialZoomLevel },
                Nt = function(t) { return t || (t = a.currItem), t.w > 0 ? r.maxSpreadZoom : 1 },
                zt = function(t, e, i, n) { return n === a.currItem.initialZoomLevel ? (i[t] = a.currItem.initialPosition[t], !0) : (i[t] = Et(t, n), i[t] > e.min[t] ? (i[t] = e.min[t], !0) : i[t] < e.max[t] && (i[t] = e.max[t], !0)) },
                Vt = function(t) {
                    var e = "";
                ...
                Zt = {
                    ...
                    isDragging: function() { return Y },
                    isZooming: function() { return G },
                    setScrollOffset: function(t, e) { ft.x = t, R = ft.y = e, St("updateScrollOffset", ft) },
                    applyZoomPan: function(t, e, i, n) { ut.x = e, ut.y = i, g = t, Pt(n) },
                    init: function() {
                        if (!s && !l) {
                            var i;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), O = t.className, s = !0, W = o.detectFeatures(), _ = W.raf, E = W.caf, P = W.transform, F = W.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{ el: a.container.children[0], wrap: 0, index: -1 }, { el: a.container.children[1], wrap: 0, index: -1 }, { el: a.container.children[2], wrap: 0, index: -1 }], k[0].el.style.display = k[2].el.style.display = "none",
                                function() {
                                    if (P) { var e = W.perspective && !D; return y = "translate" + (e ? "3d(" : "("), void(b = W.perspective ? ", 0px)" : ")") }
                                    P = "left", o.addClass(t, "pswp--ie"), Dt = function(t, e) { e.left = t + "px" }, At = function(t) {
                                ...
                                }(), m = { resize: a.updateSize, scroll: jt, keydown: Vt, click: Bt };
                            ...
                            F || o.bind(a.scrollWrap, p, a), Ct("initialZoomInEnd", function() { a.setContent(k[0], u - 1), a.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", r.focus && t.focus(), o.bind(document, "keydown", a), W.transform && o.bind(a.scrollWrap, "click", a), r.mouseUsed || o.bind(document, "mousemove", Rt), o.bind(window, "resize scroll", a), St("bindEvents") }), a.setContent(k[1], u), a.updateCurrItem(), St("afterInit"), gt || (x = setInterval(function() { $t || Y || G || g !== a.currItem.initialZoomLevel || a.updateSize() }, 1e3)), o.addClass(t, "pswp--visible")
                        }
                    },
                    close: function() { s && (s = !1, l = !0, St("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Rt), W.transform && o.unbind(a.scrollWrap, "click", a), Y && o.unbind(window, f, a), St("unbindEvents"), Ve(a.currItem, null, !0, a.destroy)) },
                    destroy: function() { St("destroy"), Fe && clearTimeout(Fe), t.setAttribute("aria-hidden", "true"), t.className = O, x && clearInterval(x), o.unbind(a.scrollWrap, p, a), o.unbind(window, "scroll", a), fe(), Ut(), kt = null },
                    panTo: function(t, e, i) { i || (t > J.min.x ? t = J.min.x : t < J.max.x && (t = J.max.x), e > J.min.y ? e = J.min.y : e < J.max.y && (e = J.max.y)), ut.x = t, ut.y = e, Pt() },
                    ...
                    zoomTo: function(t, e, i, n, a) {
                        ...
                        var l = g,
                            ...
                            u = ut.y;
                        Lt(s);
                        var d = function(e) { 1 === e ? (g = t, ut.x = s.x, ut.y = s.y) : (g = (t - l) * e + l, ut.x = (s.x - c) * e + c, ut.y = (s.y - u) * e + u), a && a(e), Pt(1 === e) };
                ...
                Me = function(t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!j || "mousedown" !== t.type) {
                            ...
                            var i = Se(t),
                                n = i.length;
                            Z = null, Ut(), Y && 1 !== n || (Y = nt = !0, o.bind(window, f, a), V = rt = ot = B = Q = q = $ = X = !1, it = null, St("firstTouchStart", i), Ot(ct, ut), lt.x = lt.y = 0, Ot(te, i[0]), Ot(ee, te), ne.x = pt.x * ht, oe = [{ x: te.x, y: te.y }], N = H = Tt(), Wt(g, !0), fe(), pe()), !G && n > 1 && !et && !Q && (v = g, X = !1, G = $ = !0, lt.y = lt.x = 0, Ot(ct, ut), Ot(Gt, i[0]), Ot(Kt, i[1]), be(Gt, Kt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, K = he(Gt, Kt))
                        }
                    }
                },
                Ie = function(t) {
                    ...
                    if (Z) {
                        ...
                        if (0 !== t)
                            if (Ot(Gt, Z[0]), Jt.x = Gt.x - te.x, Jt.y = Gt.y - te.y, G && t > 1) {
                                if (te.x = Gt.x, te.y = Gt.y, !Jt.x && !Jt.y && function(t, e) { return t.x === e.x && t.y === e.y }(Z[1], Kt)) return;
                                ...
                                if ("v" === it && r.closeOnVerticalDrag && "fit" === r.scaleMode && g === a.currItem.initialZoomLevel) { lt.y += Jt.y, ut.y += Jt.y; var c = xe(); return B = !0, St("onVerticalDrag", c), Mt(c), void Pt() }(function(t, e, i) {
                                    if (t - N > 50) {
                ...
                Ae = function(t) {
                    if (W.isOldAndroid) {
                        ...
                        t.type.indexOf("touch") > -1 && (clearTimeout(j), j = setTimeout(function() { j = 0 }, 600))
                    }
                    var e;
                    ...
                    1 === l && Ot(ee, s[0]), 0 !== l || it || et || (e || ("mouseup" === t.type ? e = { x: t.pageX, y: t.pageY, type: "mouse" } : t.changedTouches && t.changedTouches[0] && (e = { x: t.changedTouches[0].pageX, y: t.changedTouches[0].pageY, type: "touch" })), St("touchRelease", t, e));
                    var c = -1;
                    if (0 === l && (Y = !1, o.unbind(window, f, a), fe(), G ? c = 0 : -1 !== le && (c = Tt() - le)), le = 1 === l ? Tt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", G && 2 > l && (G = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Z = null, q || X || et || B)
                        if (Ut(), z || (z = De()), z.calculateSwipeSpeed("x"), B)
                            if (xe() < r.verticalDragRange) a.close();
                                ...
                                var u = ut.y,
                                    d = at;
                                Qt("verticalDrag", 0, 1, 300, o.easing.cubic.out, function(t) { ut.y = (a.currItem.initialPosition.y - u) * t + u, Mt((1 - d) * t + d), Pt() }), St("onVerticalDrag", 1)
                            }
                    else {
                        if ((Q || et) && 0 === l) {
                            if (Ee(n, z)) return;
                ...
                Ee = function(t, e) {
                    ...
                    var d, h = pt.x * ht,
                        f = Math.abs(h - ce.x);
                    return i || h > ce.x == e.lastFlickSpeed.x > 0 ? (d = Math.abs(e.lastFlickSpeed.x) > 0 ? f / Math.abs(e.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, re === u && (i = !1), et = !0, St("mainScrollAnimStart"), Qt("mainScroll", ce.x, h, d, o.easing.cubic.out, _t, function() { Ut(), et = !1, re = -1, (i || re !== u) && a.updateCurrItem(), St("mainScrollAnimComplete") }), i && a.updateCurrItem(!0), i
                },
                ...
                Le = function() {
                    ...
                    e > g ? t = e : g > i && (t = i);
                    var n, r = at;
                    return ot && !V && !rt && e > g ? (a.close(), !0) : (ot && (n = function(t) { Mt((1 - r) * t + r) }), a.zoomTo(t, 0, 200, o.easing.cubic.out, n), !0)
                };
            xt("Gestures", {
                publicMethods: {
                    initGestures: function() {
                        var t = function(t, e, i, n, o) { S = t + e, T = t + i, M = t + n, I = o ? t + o : "" };
            ...
            var Fe, Re, We, He, Ne, ze, Ve = function(e, i, n, s) {
                    ...
                    var d = n ? r.hideAnimationDuration : r.showAnimationDuration,
                        h = function() { Xt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Mt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), St("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), He = !1 };
                    if (!d || !l || void 0 === l.x) return St("initialZoom" + (n ? "Out" : "In")), g = e.initialZoomLevel, Ot(ut, e.initialPosition), Pt(), t.style.opacity = n ? 0 : 1, Mt(1), void(d ? setTimeout(function() { h() }, d) : h());
                    ! function() {
                        var i = c,
                            s = !a.currItem.src || a.currItem.loadError || r.showHideOpacity;
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, Pt()), qt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() { o.addClass(t, "pswp--animate_opacity") }, 30)), Fe = setTimeout(function() {
                            if (St("initialZoom" + (n ? "Out" : "In")), n) {
                                var a = l.w / e.w,
                                    r = { x: ut.x, y: ut.y },
                                    c = g,
                                    u = at,
                                    f = function(e) { 1 === e ? (g = a, ut.x = l.x, ut.y = l.y - R) : (g = (a - c) * e + c, ut.x = (l.x - r.x) * e + r.x, ut.y = (l.y - R - r.y) * e + r.y), Pt(), s ? t.style.opacity = 1 - e : Mt(u - e * u) };
                ...
                Be = {},
                je = [],
                Ye = { index: 0, errorMsg: '<div class="pswp__error-msg"><a href="%url%" target="_blank">The image</a> could not be loaded.</div>', forceProgressiveLoading: !1, preload: [1, 1], getNumItemsFn: function() { return Re.length } },
                $e = function(t, e, i) {
                    if (t.src && !t.loadError) {
                        var n = !i;
                        if (n && (t.vGap || (t.vGap = { top: 0, bottom: 0 }), St("parseVerticalMargin", t)), Be.x = e.x, Be.y = e.y - t.vGap.top - t.vGap.bottom, n) {
                            var o = Be.x / t.w,
                                a = Be.y / t.h;
                            t.fitRatio = a > o ? o : a;
                            var s = r.scaleMode;
            ...
            xt("Controller", {
                publicMethods: {
                    ...
                    initController: function() {
                        ...
                        }), Ct("initialLayout", function() { a.currItem.initialLayout = r.getThumbBoundsFn && r.getThumbBoundsFn(u) }), Ct("mainScrollAnimComplete", Ze), Ct("initialZoomInEnd", Ze), Ct("destroy", function() {
                    ...
                    getItemAt: function(t) { return t >= 0 && void 0 !== Re[t] && Re[t] },
                    allowProgressiveImg: function() { return r.forceProgressiveLoading || !D || r.mouseUsed || screen.width > 1200 },
                    setContent: function(t, e) {
                        ...
                        if (l) {
                            ...
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), $e(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), Xe(0, l, c, n));
                                ...
                                if (l.loadComplete = function(i) {
                                        if (s) {
                                            if (t && t.index === e) {
                                                ...
                                                i.imageAppended ? !He && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : W.transform && (et || He) ? je.push({ item: i, baseDiv: c, img: i.img, index: e, holder: t, clearPlaceholder: !0 }) : Xe(0, i, c, i.img, 0, !0)
                                            }
                                ...
                                l.loading || qe(l), a.allowProgressiveImg() && (!We && W.transform ? je.push({ item: l, baseDiv: c, img: l.img, index: e, holder: t }) : Xe(0, l, c, l.img, 0, !0))
                            }
            ...
            xt("Tap", {
                publicMethods: {
                    initTap: function() { Ct("firstTouchStart", a.onTapStart), Ct("touchRelease", a.onTapRelease), Ct("destroy", function() { Je = {}, Ge = null }) },
                    onTapStart: function(t) { t.length > 1 && (clearTimeout(Ge), Ge = null) },
                    onTapRelease: function(t, e) {
                        if (e && !q && !$ && !$t) {
                            var i = e;
                            if (Ge && (clearTimeout(Ge), Ge = null, function(t, e) { return Math.abs(t.x - e.x) < 25 && Math.abs(t.y - e.y) < 25 }(i, Je))) return void St("doubleTap", i);
                            ...
                            Ot(Je, i), Ge = setTimeout(function() { ti(t, e), Ge = null }, 300)
                        }
                    }
                }
            }), xt("DesktopZoom", {
                publicMethods: {
                    initDesktopZoom: function() { F || (D ? Ct("mouseUsed", function() { a.setupDesktopZoom() }) : a.setupDesktopZoom(!0)) },
                    setupDesktopZoom: function(e) {
                        Ke = {};
                        var i = "wheel mousewheel DOMMouseScroll";
                        Ct("bindEvents", function() { o.bind(t, i, a.handleMouseWheel) }), Ct("unbindEvents", function() { Ke && o.unbind(t, i, a.handleMouseWheel) }), a.mouseZoomedIn = !1;
                        var n, r = function() { a.mouseZoomedIn && (o.removeClass(t, "pswp--zoomed-in"), a.mouseZoomedIn = !1), 1 > g ? o.addClass(t, "pswp--zoom-allowed") : o.removeClass(t, "pswp--zoom-allowed"), s() },
            ...
            var ei, ii, ni, oi, ai, ri, si, li, ci, ui, di, hi, fi = { history: !0, galleryUID: 1 },
                ...
                publicMethods: {
                    initHistory: function() {
                        if (o.extend(r, fi, !0), r.history) {
                            di = window.location, ui = !1, ci = !1, li = !1, si = pi(), hi = "pushState" in history, si.indexOf("gid=") > -1 && (si = (si = si.split("&gid=")[0]).split("?gid=")[0]), Ct("afterChange", a.updateURL), Ct("unbindEvents", function() { o.unbind(window, "hashchange", a.onHashChange) });
                            ...
                            Ct("unbindEvents", function() { c && t() }), Ct("destroy", function() { ri || t() }), Ct("firstUpdate", function() { u = gi().pid });
                    ...
                    onHashChange: function() { return pi() === si ? (ci = !0, void a.close()) : void(oi || (ai = !0, a.goTo(gi().pid), ai = !1)) },
                    updateURL: function() { mi(), ai || (li ? ei = setTimeout(vi, 800) : vi()) }
                }
            }), o.extend(a, Zt)
        }
    }),
    function(t, e) { "function" == typeof define && define.amd ? define(e) : "object" == typeof exports ? module.exports = e() : t.PhotoSwipeUI_Default = e() }(this, function() {
        ...
        return function(t, e) {
            var i, n, o, a, r, s, l, c, u, d, h, f, p, m, g, v, y, b, x = this,
                ...
                L = 0,
                F = function() { clearTimeout(b), L = 0, u && x.setIdle(!1) },
                R = function(t) {
                ...
                N = [{ name: "caption", option: "captionEl", onInit: function(t) { o = t } }, { name: "share-modal", option: "shareEl", onInit: function(t) { l = t }, onTap: function() { D() } }, { name: "button--share", option: "shareEl", onInit: function(t) { s = t }, onTap: function() { D() } }, { name: "button--zoom", option: "zoomEl", onTap: t.toggleDesktopZoom }, { name: "counter", option: "counterEl", onInit: function(t) { r = t } }, { name: "button--close", option: "closeEl", onTap: t.close }, { name: "button--arrow--left", option: "arrowEl", onTap: t.prev }, { name: "button--arrow--right", option: "arrowEl", onTap: t.next }, { name: "button--fs", option: "fullscreenEl", onTap: function() { i.isFullscreen() ? i.exit() : i.enter() } }, { name: "preloader", option: "preloaderEl", onInit: function(t) { h = t } }];
            x.init = function() {
                e.extend(t.options, S, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen,
                    ...
                    }), d("bindEvents", function() { e.bind(n, "pswpTap click", T), e.bind(t.scrollWrap, "pswpTap", x.onGlobalTap), t.likelyTouchDevice || e.bind(t.scrollWrap, "mouseover", x.onMouseOver) }), d("unbindEvents", function() { C || D(), y && clearInterval(y), e.unbind(document, "mouseout", R), e.unbind(document, "mousemove", F), e.unbind(n, "pswpTap click", T), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null) }), d("destroy", function() { g.captionEl && (a && n.removeChild(a), e.removeClass(o, "pswp__caption--empty")), l && (l.children[0].onclick = null), e.removeClass(n, "pswp__ui--over-close"), e.addClass(n, "pswp__ui--hidden"), x.setIdle(!1) }), g.showAnimationDuration || e.removeClass(n, "pswp__ui--hidden"), d("initialZoomIn", function() { g.showAnimationDuration && e.removeClass(n, "pswp__ui--hidden") }), d("initialZoomOut", function() { e.addClass(n, "pswp__ui--hidden") }), d("parseVerticalMargin", H),
                    function() {
                        var t, i, o, a = function(n) {
                            if (n)
                                for (var a = n.length, r = 0; a > r; r++) { t = n[r], i = t.className; for (var s = 0; s < N.length; s++) o = N[s], i.indexOf("pswp__" + o.name) > -1 && (g[o.option] ? (e.removeClass(t, "pswp__element--disabled"), o.onInit && o.onInit(t)) : e.addClass(t, "pswp__element--disabled")) }
                        };
                        a(n.children);
                        var r = e.getChildByClass(n, "pswp__top-bar");
                        r && a(r.children)
                    }(), g.shareEl && s && l && (C = !0), P(), g.timeToIdle && d("mouseUsed", function() { e.bind(document, "mousemove", F), e.bind(document, "mouseout", R), y = setInterval(function() { 2 == ++L && x.setIdle(!0) }, g.timeToIdle / 2) }), g.fullscreenEl && !e.features.isOldAndroid && (i || (i = x.getFullscreenAPI()), i ? (e.bind(document, i.eventK, x.updateFullscreen), x.updateFullscreen(), e.addClass(t.template, "pswp--supports-fs")) : e.removeClass(t.template, "pswp--supports-fs")), g.preloaderEl && (W(!0), d("beforeChange", function() { clearTimeout(p), p = setTimeout(function() { t.currItem && t.currItem.loading ? (!t.allowProgressiveImg() || t.currItem.img && !t.currItem.img.naturalWidth) && W(!1) : W(!0) }, g.loadingIndicatorDelay) }), d("imageLoadComplete", function(e, i) { t.currItem === i && W(!0) }))
            }, x.setIdle = function(t) { u = t, I(n, "ui--idle", t) }, x.update = function() { k && t.currItem ? (x.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), I(o, "caption--empty", !t.currItem.title)), w = !0) : w = !1, C || D(), P() }, x.updateFullscreen = function(n) { n && setTimeout(function() { t.setScrollOffset(0, e.getScrollY()) }, 50), e[(i.isFullscreen() ? "add" : "remove") + "Class"](t.template, "pswp--fs") }, x.updateIndexIndicator = function() { g.counterEl && (r.innerHTML = t.getCurrentIndex() + 1 + g.indexIndicatorSep + g.getNumItemsFn()) }, x.onGlobalTap = function(i) {
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
        ...
        t.fn.sticky = function(e) {
            ...
            return this.each(function() {
                ...
                function f() {
                    ...
                    if (c < r) {
                        if (i.stickyClass && e.addClass(i.stickyClass), e.after(u).css({ position: "fixed", top: s, width: p }), n && e.css({ zIndex: l }), o && f < r) {
                            var m = f - r + s;
                            e.css({ top: m })
                        }
    ...
    function t(e, i, n) {
        ...
        1: [function(t, e, i) { "use strict"; var n = t("../main"); "function" == typeof define && define.amd ? define(n) : (window.PerfectScrollbar = n, void 0 === window.Ps && (window.Ps = n)) }, { "../main": 7 }],
        2: [function(t, e, i) {
            "use strict";
            i.add = function(t, e) {
        ...
        3: [function(t, e, i) {
            "use strict";
            var n = { e: function(t, e) { var i = document.createElement(t); return i.className = e, i }, appendTo: function(t, e) { return e.appendChild(t), t } };
            n.css = function(t, e, i) { return "object" == typeof e ? function(t, e) { for (var i in e) { var n = e[i]; "number" == typeof n && (n = n.toString() + "px"), t.style[i] = n } return t }(t, e) : void 0 === i ? function(t, e) { return window.getComputedStyle(t)[e] }(t, e) : function(t, e, i) { return "number" == typeof i && (i = i.toString() + "px"), t.style[e] = i, t }(t, e, i) }, n.matches = function(t, e) { return void 0 !== t.matches ? t.matches(e) : void 0 !== t.matchesSelector ? t.matchesSelector(e) : void 0 !== t.webkitMatchesSelector ? t.webkitMatchesSelector(e) : void 0 !== t.mozMatchesSelector ? t.mozMatchesSelector(e) : void 0 !== t.msMatchesSelector ? t.msMatchesSelector(e) : void 0 }, n.remove = function(t) { void 0 !== t.remove ? t.remove() : t.parentNode && t.parentNode.removeChild(t) }, n.queryChildren = function(t, e) { return Array.prototype.filter.call(t.childNodes, function(t) { return n.matches(t, e) }) }, e.exports = n
        }, {}],
        4: [function(t, e, i) {
            "use strict";
            var n = function(t) { this.element = t, this.events = {} };
            n.prototype.bind = function(t, e) { void 0 === this.events[t] && (this.events[t] = []), this.events[t].push(e), this.element.addEventListener(t, e, !1) }, n.prototype.unbind = function(t, e) {
                var i = void 0 !== e;
                this.events[t] = this.events[t].filter(function(n) { return !(!i || n === e) || (this.element.removeEventListener(t, n, !1), !1) }, this)
            }, n.prototype.unbindAll = function() { for (var t in this.events) this.unbind(t) };
            var o = function() { this.eventElements = [] };
            o.prototype.eventElement = function(t) { var e = this.eventElements.filter(function(e) { return e.element === t })[0]; return void 0 === e && (e = new n(t), this.eventElements.push(e)), e }, o.prototype.bind = function(t, e, i) { this.eventElement(t).bind(e, i) }, o.prototype.unbind = function(t, e, i) { this.eventElement(t).unbind(e, i) }, o.prototype.unbindAll = function() { for (var t = 0; t < this.eventElements.length; t++) this.eventElements[t].unbindAll() }, o.prototype.once = function(t, e, i) {
        ...
        6: [function(t, e, i) {
            ...
            function n(t) { return function(e, i) { t(e, "ps--in-scrolling"), void 0 !== i ? t(e, "ps--" + i) : (t(e, "ps--x"), t(e, "ps--y")) } }
            var o = t("./class"),
                a = t("./dom"),
            ...
            i.extend = function(t, e) { var i = s(t); for (var n in e) i[n] = s(e[n]); return i }, i.isEditable = function(t) { return a.matches(t, "input,[contenteditable]") || a.matches(t, "select,[contenteditable]") || a.matches(t, "textarea,[contenteditable]") || a.matches(t, "button,[contenteditable]") }, i.removePsClasses = function(t) {
                for (var e = o.list(t), i = 0; i < e.length; i++) {
                    var n = e[i];
                    0 === n.indexOf("ps-") && o.remove(t, n)
                }
            }, i.outerWidth = function(t) { return r(a.css(t, "width")) + r(a.css(t, "paddingLeft")) + r(a.css(t, "paddingRight")) + r(a.css(t, "borderLeftWidth")) + r(a.css(t, "borderRightWidth")) }, i.startScrolling = n(o.add), i.stopScrolling = n(o.remove), i.env = { isWebKit: "undefined" != typeof document && "WebkitAppearance" in document.documentElement.style, supportsTouch: "undefined" != typeof window && ("ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch), supportsIePointer: "undefined" != typeof window && null !== window.navigator.msMaxTouchPoints }
        }, { "./class": 2, "./dom": 3 }],
        7: [function(t, e, i) {
            "use strict";
        ...
        11: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                (function(t, e) {
                    ...
                    e.event.bind(e.scrollbarX, "mousedown", function(i) { l = i.pageX, a = n.toInt(o.css(e.scrollbarX, "left")) * e.railXRatio, n.startScrolling(t, "x"), e.event.bind(e.ownerDocument, "mousemove", c), e.event.once(e.ownerDocument, "mouseup", u), i.stopPropagation(), i.preventDefault() })
                })(t, e),
                function(t, e) {
                    function i(i) {
                    ...
                    e.event.bind(e.scrollbarY, "mousedown", function(i) { l = i.pageY, a = n.toInt(o.css(e.scrollbarY, "top")) * e.railYRatio, n.startScrolling(t, "y"), e.event.bind(e.ownerDocument, "mousemove", c), e.event.once(e.ownerDocument, "mouseup", u), i.stopPropagation(), i.preventDefault() })
                }(t, e)
            }
        ...
        12: [function(t, e, i) {
            ...
            var o = t("../../lib/helper"),
                ...
                s = t("../update-geometry"),
                l = t("../update-scroll");
            e.exports = function(t) { n(t, r.get(t)) }
        }, { "../../lib/dom": 3, "../../lib/helper": 6, "../instances": 18, "../update-geometry": 19, "../update-scroll": 20 }],
        13: [function(t, e, i) {
            "use strict";
            ...
            var o = t("../instances"),
                a = t("../update-geometry"),
                r = t("../update-scroll");
            e.exports = function(t) { n(t, o.get(t)) }
        }, { "../instances": 18, "../update-geometry": 19, "../update-scroll": 20 }],
        14: [function(t, e, i) {
            "use strict";
            var n = t("../instances"),
                o = t("../update-geometry");
            e.exports = function(t) {! function(t, e) { e.event.bind(t, "scroll", function() { o(t) }) }(t, n.get(t)) }
        ...
        15: [function(t, e, i) {
            ...
            function n(t, e) {
                ...
                function n() { l && (clearInterval(l), l = null), o.stopScrolling(t) }
                var l = null,
                    c = { top: 0, left: 0 },
                    u = !1;
                e.event.bind(e.ownerDocument, "selectionchange", function() { t.contains(function() { var t = window.getSelection ? window.getSelection() : document.getSelection ? document.getSelection() : ""; return 0 === t.toString().length ? null : t.getRangeAt(0).commonAncestorContainer }()) ? u = !0 : (u = !1, n()) }), e.event.bind(window, "mouseup", function() { u && (u = !1, n()) }), e.event.bind(window, "keyup", function() { u && (u = !1, n()) }), e.event.bind(window, "mousemove", function(e) {
                    if (u) {
            ...
            var o = t("../../lib/helper"),
                ...
                r = t("../update-geometry"),
                s = t("../update-scroll");
            e.exports = function(t) { n(t, a.get(t)) }
                ...
                (n.env.supportsTouch || n.env.supportsIePointer) && function(t, e, i, n) {
                    function s(i, n) {
                        var o = t.scrollTop,
                            ...
                            r = Math.abs(i),
                            s = Math.abs(n);
                        if (s > r) { if (n < 0 && o === e.contentHeight - e.containerHeight || n > 0 && 0 === o) return !e.settings.swipePropagation } else if (r > s && (i < 0 && a === e.contentWidth - e.containerWidth || i > 0 && 0 === a)) return !e.settings.swipePropagation;
                        return !0
                    }
                    ...
                    function m() {!x && w && (w = !1, e.settings.swipeEasing && (clearInterval(b), b = setInterval(function() { return o.get(t) && (y.x || y.y) ? Math.abs(y.x) < .01 && Math.abs(y.y) < .01 ? void clearInterval(b) : (l(30 * y.x, 30 * y.y), y.x *= .8, void(y.y *= .8)) : void clearInterval(b) }, 10))) }
                    var g = {},
                        v = 0,
                        y = {},
                        b = null,
        ...
        17: [function(t, e, i) {
            ...
            e.exports = function(t, e) {
                ...
                var i = a.add(t);
                i.settings = n.extend(i.settings, e), o.add(t, "ps--theme_" + i.settings.theme), i.settings.handlers.forEach(function(e) { s[e](t) }), l(t), r(t)
            }
        ...
        18: [function(t, e, i) {
            ...
            function n(t) { return t.getAttribute("data-ps-id") }
            var o = t("../lib/helper"),
                a = t("../lib/class"),
                r = t("./default-setting"),
                s = t("../lib/dom"),
            ...
            i.add = function(t) {
                var e = c();
                return function(t, e) { t.setAttribute("data-ps-id", e) }(t, e), u[e] = new function(t) {
                    function e() { a.add(t, "ps--focus") }

                    function i() { a.remove(t, "ps--focus") }
                    var n = this;
    ...
    function(t) {
        ...
        t(document).ready(function() {
            ...
            var o = this;
            return this.$el = t(this), this.$document = t(document), this.SELS = { CHIPS: ".chips", CHIP: ".chip", INPUT: "input", DELETE: ".fa", SELECTED_CHIP: ".selected" }, "data" === n ? this.$el.data("chips") : "options" === n ? this.$el.data("options") : (this.$el.data("options", t.extend({}, i, n)), this.init = function() {
                var e = 0;
                o.$el.each(function() {
                    var i = t(this);
                ...
                var e = o.SELS;
                o.$document.on("click", e.CHIPS, function(i) { t(i.target).find(e.INPUT).focus() }), o.$document.on("click", e.CHIP, function() { t(e.CHIP).removeClass("selected"), t(this).toggleClass("selected") }), o.$document.on("keydown", function(i) {
                ...
                }), o.$document.on("focusin", e.CHIPS + " " + e.INPUT, function(i) { t(i.target).closest(e.CHIPS).addClass("focus"), t(e.CHIP).removeClass("selected") }), o.$document.on("focusout", e.CHIPS + " " + e.INPUT, function(i) { t(i.target).closest(e.CHIPS).removeClass("focus") }), o.$document.on("keydown", e.CHIPS + " " + e.INPUT, function(i) {
                    var n = t(i.target),
                        a = n.closest(e.CHIPS),
                        r = a.data("index"),
                        s = a.children(e.CHIP).length;
                    if (13 === i.which) return i.preventDefault(), o.addChip(r, { tag: n.val() }, a), void n.val("");
                ...
                var e = "";
                t.data("chips").forEach(function(t) { e += o.renderChip(t) }), e += '<input class="input" placeholder="">', t.html(e), o.setPlaceholder(t)
            }, this.renderChip = function(t) { if (t.tag) { var e = '<div class="chip">' + t.tag; return t.image && (e += ' <img src="' + t.image + '"> '), e += '<i class="close fa fa-times"></i>', e += "</div>" } }, this.setPlaceholder = function(t) {
            ...
            }, this.getChipsElement = function(t, e) { return e.eq(t) }, this.init(), void(e || (this.handleEvents(), e = !0)))
        }
    }(jQuery),
    function(t) {
        "use strict";
        Date.now || (Date.now = function() { return (new Date).getTime() }), t.requestAnimationFrame || function() {
            ...
            if (/iP(ad|hone|od).*OS 6/.test(t.navigator.userAgent) || !t.requestAnimationFrame || !t.cancelAnimationFrame) {
                ...
                t.requestAnimationFrame = function(t) {
                    var e = Date.now(),
                        i = Math.max(o + 16, e);
                    return setTimeout(function() { t(o = i) }, i - e)
        ...
        function f() { n = t.innerWidth || document.documentElement.clientWidth, o = t.innerHeight || document.documentElement.clientHeight }
        f();
        var p = [],
            m = function() {
                var t = 0;
                return function(e, i) {
                    var n;
                    if (this.$item = e, this.defaults = { type: "scroll", speed: .5, imgSrc: null, imgWidth: null, imgHeight: null, elementInViewport: null, zIndex: -100, noAndroid: !1, noIos: !0, onScroll: null, onInit: null, onDestroy: null, onCoverImage: null }, n = JSON.parse(this.$item.getAttribute("data-jarallax") || "{}"), this.options = this.extend({}, this.defaults, n, i), !(!a || l && this.options.noAndroid || c && this.options.noIos)) {
                        this.options.speed = Math.min(2, Math.max(-1, parseFloat(this.options.speed)));
                        var o = this.options.elementInViewport;
                        o && "object" == typeof o && void 0 !== o.length && (o = o[0]), !o instanceof Element && (o = null), this.options.elementInViewport = o, this.instanceID = t++, this.image = { src: this.options.imgSrc || null, $container: null, $item: null, width: this.options.imgWidth || null, height: this.options.imgHeight || null, useImgTag: c || l || d, position: !r || u ? "absolute" : "fixed" }, this.initImg() && this.init()
                    }
                }
            }();

        function g(t, e, i) { t.addEventListener ? t.addEventListener(e, i) : t.attachEvent("on" + e, function() { i.call(t) }) }

        function v(e) { t.requestAnimationFrame(function() { "scroll" !== e.type && f(); for (var t = 0, i = p.length; t < i; t++) "scroll" !== e.type && (p[t].coverImage(), p[t].clipContainer()), p[t].onScroll() }) }
        m.prototype.css = function(e, i) { if ("string" == typeof i) return t.getComputedStyle ? t.getComputedStyle(e).getPropertyValue(i) : e.style[i]; for (var n in i.transform && (r && (i.transform += " translateZ(0)"), i.WebkitTransform = i.MozTransform = i.msTransform = i.OTransform = i.transform), i) e.style[n] = i[n]; return e }, m.prototype.extend = function(t) {
            t = t || {};
            for (var e = 1; e < arguments.length; e++)
                if (arguments[e])
                    for (var i in arguments[e]) arguments[e].hasOwnProperty(i) && (t[i] = arguments[e][i]);
            return t
        }, m.prototype.initImg = function() { return null === this.image.src && (this.image.src = this.css(this.$item, "background-image").replace(/^url\(['"]?/g, "").replace(/['"]?\)$/g, "")), !(!this.image.src || "none" === this.image.src) }, m.prototype.init = function() {
            var t = this,
                e = { position: "absolute", top: 0, left: 0, width: "100%", height: "100%", overflow: "hidden", pointerEvents: "none" },
                i = {};
            t.$item.setAttribute("data-jarallax-original-styles", t.$item.getAttribute("style")), "static" === t.css(t.$item, "position") && t.css(t.$item, { position: "relative" }), "auto" === t.css(t.$item, "z-index") && t.css(t.$item, { zIndex: 0 }), t.image.$container = document.createElement("div"), t.css(t.image.$container, e), t.css(t.image.$container, { visibility: "hidden", "z-index": t.options.zIndex }), t.image.$container.setAttribute("id", "jarallax-container-" + t.instanceID), t.$item.appendChild(t.image.$container), t.image.useImgTag ? (t.image.$item = document.createElement("img"), t.image.$item.setAttribute("src", t.image.src), i = t.extend({ "max-width": "none" }, e, i)) : (t.image.$item = document.createElement("div"), i = t.extend({ "background-position": "50% 50%", "background-size": "100% auto", "background-repeat": "no-repeat no-repeat", "background-image": 'url("' + t.image.src + '")' }, e, i));
            for (var n = 0, o = t.$item; null !== o && o !== document && 0 === n;) {
                var a = t.css(o, "-webkit-transform") || t.css(o, "-moz-transform") || t.css(o, "transform");
                a && "none" !== a && (n = 1, t.css(t.image.$container, { transform: "translateX(0) translateY(0)" })), o = o.parentNode
            }

            function r() { t.coverImage(), t.clipContainer(), t.onScroll(!0), t.options.onInit && t.options.onInit.call(t), setTimeout(function() { t.$item && t.css(t.$item, { "background-image": "none", "background-attachment": "scroll", "background-size": "auto" }) }, 0) }(n || "opacity" === t.options.type || "scale" === t.options.type || "scale-opacity" === t.options.type) && (t.image.position = "absolute"), i.position = t.image.position, t.css(t.image.$item, i), t.image.$container.appendChild(t.image.$item), t.image.width && t.image.height ? r() : t.getImageSize(t.image.src, function(e, i) { t.image.width = e, t.image.height = i, r() }), p.push(t)
        }, m.prototype.destroy = function() {
            for (var t = 0, e = p.length; t < e; t++)
                if (p[t].instanceID === this.instanceID) { p.splice(t, 1); break }
            ...
            if (t && e) {
                var i = new Image;
                i.onload = function() { e(i.width, i.height) }, i.src = t
            }
            ...
            if (this.image.width && this.image.height) {
                var t = this.image.$container.getBoundingClientRect(),
                    ...
                    h = 0,
                    f = 0;
                l && (c = s < 0 ? s * Math.max(i, o) : s * (i + o), s > 1 ? d = Math.abs(c - o) : s < 0 ? d = c / s + Math.abs(c) : d += Math.abs(o - i) * (1 - s), c /= 2), (u = d * a / r) < e && (d = (u = e) * r / a), l ? (h = n + (e - u) / 2, f = (o - d) / 2) : (h = (e - u) / 2, f = (i - d) / 2), "absolute" === this.image.position && (h -= n), this.parallaxScrollDistance = c, this.css(this.image.$item, { width: u + "px", height: d + "px", marginLeft: h + "px", marginTop: f + "px" }), this.options.onCoverImage && this.options.onCoverImage.call(this)
            }
        }, m.prototype.isVisible = function() { return this.isElementInViewport || !1 }, m.prototype.onScroll = function(t) {
            if (this.image.width && this.image.height) {
                var e = this.$item.getBoundingClientRect(),
                    i = e.top,
                    a = e.height,
                    r = { visibility: "visible", backgroundPosition: "50% 50%" },
                    s = e;
                if (this.options.elementInViewport && (s = this.options.elementInViewport.getBoundingClientRect()), this.isElementInViewport = s.bottom >= 0 && s.right >= 0 && s.top <= o && s.left <= n, t || this.isElementInViewport) {
                    ...
                    if ("scroll" === this.options.type || "scroll-opacity" === this.options.type) { var v = this.parallaxScrollDistance * p; "absolute" === this.image.position && (v -= i), r.transform = "translateY(" + v + "px)" }
                    this.css(this.image.$item, r), this.options.onScroll && this.options.onScroll.call(this, { section: e, beforeTop: l, beforeTopEnd: c, afterTop: u, beforeBottom: d, beforeBottomEnd: h, afterBottom: f, visiblePercent: m, fromViewportCenter: p })
                }
            }
        ...
        y.constructor = m;
        var b = t.jarallax;
        if (t.jarallax = y, t.jarallax.noConflict = function() { return t.jarallax = b, this }, "undefined" != typeof jQuery) {
            var x = function() {
                var e = arguments || [];
            ...
            jQuery.fn.jarallax = x, jQuery.fn.jarallax.noConflict = function() { return jQuery.fn.jarallax = w, this }
        }
        g(t, "DOMContentLoaded", function() { y(document.querySelectorAll("[data-jarallax], [data-jarallax-video]")) })
    }(window),
    function(t) {
        "use strict";
        ...
        var n = function() {
            var t = 0;
            return function(e, i) {
                this.url = e, this.options_default = { autoplay: 1, loop: 1, mute: 1, controls: 0, startTime: 0, endTime: 0 }, this.options = function(t) {
                    t = t || {};
                    for (var e = 1; e < arguments.length; e++)
                        if (arguments[e])
                            for (var i in arguments[e]) arguments[e].hasOwnProperty(i) && (t[i] = arguments[e][i]);
        ...
        n.prototype.parseURL = function(t) {
            var e, i = !(!(e = t.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== e[1].length) && e[1],
                n = function(t) { var e = t.match(/https?:\/\/(?:www\.|player\.)?vimeo.com\/(?:channels\/(?:\w+\/)?|groups\/([^\/]*)\/videos\/|album\/(\d+)\/video\/|video\/|)(\d+)(?:$|\/|\?)/); return !(!e || !e[3]) && e[3] }(t),
                o = function(t) {
        ...
        }, n.prototype.isValid = function() { return !!this.videoID }, n.prototype.on = function(t, e) { this.userEventsList = this.userEventsList || [], (this.userEventsList[t] || (this.userEventsList[t] = [])).push(e) }, n.prototype.off = function(t, e) {
            ...
            var e = this;
            e.player && ("youtube" === e.type && e.player.playVideo && (void 0 !== t && e.player.seekTo(t || 0), e.player.playVideo()), "vimeo" === e.type && (void 0 !== t && e.player.setCurrentTime(t), e.player.getPaused().then(function(t) { t && e.player.play() })), "local" === e.type && (void 0 !== t && (e.player.currentTime = t), e.player.play()))
        }, n.prototype.pause = function() { this.player && ("youtube" === this.type && this.player.pauseVideo && this.player.pauseVideo(), "vimeo" === this.type && this.player.pause(), "local" === this.type && this.player.pause()) }, n.prototype.getImageURL = function(t) {
            var e = this;
            ...
            n.$iframe ? e(n.$iframe) : n.onAPIready(function() {
                ...
                if ("local" === n.type) {
                    ...
                    var m;
                    n.player = n.player || n.$iframe, i(n.player, "playing", function(t) { m || n.fire("started", t), m = 1 }), i(n.player, "timeupdate", function() { n.options.endTime && n.options.endTime && this.currentTime >= n.options.endTime && (n.options.loop ? n.play(n.options.startTime) : n.pause()) }), i(n.player, "play", function(t) { n.fire("play", t) }), i(n.player, "pause", function(t) { n.fire("pause", t) }), i(n.player, "ended", function(t) { n.fire("end", t) }), i(n.player, "loadedmetadata", function() { n.videoWidth = this.videoWidth || 1280, n.videoHeight = this.videoHeight || 720, n.fire("ready"), n.options.autoplay && n.play(n.options.startTime) })
                }
                e(n.$iframe)
            })
        }, n.prototype.init = function() { this.playerID = "VideoWorker-" + this.ID };
        var o = 0,
            a = 0;
        ...
        n.prototype.onAPIready = function(e) {
            if ("youtube" === this.type && ("undefined" != typeof YT && 0 !== YT.loaded || r ? "object" == typeof YT && 1 === YT.loaded ? e() : l.done(function() { e() }) : (r = 1, t.onYouTubeIframeAPIReady = function() { t.onYouTubeIframeAPIReady = null, l.resolve("done"), e() })), "vimeo" === this.type)
                if ("undefined" != typeof Vimeo || s) "undefined" != typeof Vimeo ? e() : c.done(function() { e() });
                else { s = 1; var i = setInterval(function() { "undefined" != typeof Vimeo && (clearInterval(i), c.resolve("done"), e()) }, 20) }
                "local" === this.type && e()
        }, t.VideoWorker = n
    }(window),
    function() {
        ...
        if ("undefined" != typeof jarallax) {
            ...
            t.prototype.init = function() {
                ...
                e.apply(t), t.video && t.video.getIframe(function(e) {
                    var i = e.parentNode;
                    t.css(e, { position: t.image.position, top: "0px", left: "0px", right: "0px", bottom: "0px", width: "100%", height: "100%", maxWidth: "none", maxHeight: "none", visibility: "hidden", margin: 0, zIndex: -1 }), t.$video = e, t.image.$container.appendChild(e), i.parentNode.removeChild(i)
                })
            };
            var i = t.prototype.coverImage;
            t.prototype.coverImage = function() { i.apply(this), this.video && "IFRAME" === this.image.$item.nodeName && this.css(this.image.$item, { height: this.image.$item.getBoundingClientRect().height + 400 + "px", marginTop: -200 + parseFloat(this.css(this.image.$item, "margin-top")) + "px" }) };
            ...
            t.prototype.destroy = function() { o.apply(this) }
        }
        ...
        return t = $.extend({ data: {} }, t), this.each(function() {
            ...
            }), i.on("click", "li", function() { e.val($(this).text()), i.empty() }), $(".mdb-autocomplete-clear").on("click", function(t) { t.preventDefault(), e.val(""), $(this).css("visibility", "hidden"), i.empty(), $(this).parent().find("label").removeClass("active") })
        })
